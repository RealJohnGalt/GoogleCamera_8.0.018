...
# direct methods
.method public constructor <init>(Lcom/google/android/apps/camera/processing/ProcessingService;Lfkh;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Liby;->a:Lcom/google/android/apps/camera/processing/ProcessingService;

    iput-object p2, p0, Liby;->b:Lfkh;
...
.method public final run()V
    ...
    iget-object v0, p0, Liby;->a:Lcom/google/android/apps/camera/processing/ProcessingService;

    iget-object v1, p0, Liby;->b:Lfkh;

    :goto_0
    :try_start_0
    iget-object v2, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->l:Licd;

    iget-object v3, v2, Licd;->b:Ljava/lang/Object;
    ...
    :try_start_1
    iget-object v4, v2, Licd;->c:Ljava/util/LinkedList;
    ...
    iget-object v6, v2, Licd;->a:Lncr;

    iget-object v2, v2, Licd;->c:Ljava/util/LinkedList;
    ...
    invoke-interface {v6, v2}, Lncr;->b(Ljava/lang/String;)V
    ...
    :cond_0
    iget-object v4, v2, Licd;->a:Lncr;

    iget-boolean v6, v2, Licd;->e:Z
    ...
    :try_start_3
    iput-object v4, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->e:Licf;

    iget-boolean v5, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->f:Z

    if-eqz v5, :cond_1

    iget-object v5, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->e:Licf;

    invoke-interface {v5}, Licf;->b()V
    ...
    :try_start_4
    invoke-interface {v4}, Licf;->a()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v1, v3}, Lfkh;->a(Ljava/lang/String;)V
    ...
    invoke-interface {v4}, Licf;->d()Lice;

    move-result-object v2

    if-eqz v2, :cond_2

    invoke-interface {v2, v0}, Lice;->a(Licg;)V

    :cond_2
    invoke-static {}, Ljava/lang/System;->gc()V

    iget-object v2, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->d:Lich;

    invoke-interface {v4}, Licf;->a()Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v3}, Lich;->a(Ljava/lang/String;)V
    ...
    invoke-interface {v4, v0}, Licf;->a(Landroid/content/Context;)V
    ...
    :try_start_7
    iput-object v5, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->e:Licf;
    ...
    :try_start_f
    iget-object v3, v0, Lcom/google/android/apps/camera/processing/ProcessingService;->p:Lmtl;

    new-instance v4, Libz;

    invoke-direct {v4, v2}, Libz;-><init>(Ljava/lang/Exception;)V

    invoke-virtual {v3, v4}, Lmtl;->execute(Ljava/lang/Runnable;)V
    :try_end_f
    .catchall {:try_start_f .. :try_end_f} :catchall_4

    :goto_2
    invoke-virtual {v1}, Lfkh;->b()V
