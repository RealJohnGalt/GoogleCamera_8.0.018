...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lawr;->b:Landroid/graphics/Paint;
    ...
    sput-object v0, Lawr;->c:Landroid/graphics/Paint;
    ...
    sget-object v5, Lprz;->CUNSPaRYUjZbzCr:Ljava/lang/String;
    ...
    sget-object v4, Landroidx/preference/util/Field;->dgdFkd:Ljava/lang/String;
    ...
    sput-object v0, Lawr;->e:Ljava/util/Set;
    ...
    :goto_0
    sput-object v0, Lawr;->a:Ljava/util/concurrent/locks/Lock;

    new-instance v0, Landroid/graphics/Paint;

    invoke-direct {v0, v2}, Landroid/graphics/Paint;-><init>(I)V

    sput-object v0, Lawr;->d:Landroid/graphics/Paint;
...
.method public static a(Laqo;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-static {p1}, Lawr;->a(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;

    move-result-object v1

    invoke-interface {p0, p2, p3, v1}, Laqo;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;

    move-result-object p0

    invoke-static {p1, p0}, Lawr;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;)V

    invoke-static {p1, p0, v0}, Lawr;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
    ...
    sget-object v0, Lawr;->a:Ljava/util/concurrent/locks/Lock;
    ...
    sget-object p1, Lawr;->b:Landroid/graphics/Paint;

    invoke-virtual {v1, p0, p2, p1}, Landroid/graphics/Canvas;->drawBitmap(Landroid/graphics/Bitmap;Landroid/graphics/Matrix;Landroid/graphics/Paint;)V

    invoke-static {v1}, Lawr;->a(Landroid/graphics/Canvas;)V
    :try_end_0
...
.method public static b(Laqo;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 2
    ...
    invoke-interface {p0, p3, v0, v1}, Laqo;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-static {p1, p0, p3}, Lawr;->a(Landroid/graphics/Bitmap;Landroid/graphics/Bitmap;Landroid/graphics/Matrix;)V
...
.method public static c(Laqo;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 1
    ...
    :cond_0
    invoke-static {p0, p1, p2, p3}, Lawr;->b(Laqo;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
...
.method public static d(Laqo;Landroid/graphics/Bitmap;II)Landroid/graphics/Bitmap;
    .locals 6
    ...
    invoke-static {p1}, Lawr;->b(Landroid/graphics/Bitmap;)Landroid/graphics/Bitmap$Config;
    ...
    invoke-interface {p0, v2, v4, p3}, Laqo;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    invoke-interface {p0, p2, p2, v2}, Laqo;->a(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    sget-object v2, Lawr;->a:Ljava/util/concurrent/locks/Lock;
    ...
    invoke-static {v4}, Lawr;->a(Landroid/graphics/Canvas;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-interface {p0, p3}, Laqo;->a(Landroid/graphics/Bitmap;)V
