...
.method public static constructor <clinit>()V
    ...
    const-string v0, "GSExecutor"

    invoke-static {v0}, Lkxm;->a(Ljava/lang/String;)Ljava/lang/String;

    move-result-object v0

    sput-object v0, Lbpt;->b:Ljava/lang/String;
...
.method public constructor <init>(Ljava/util/concurrent/Executor;Ljava/util/concurrent/ScheduledExecutorService;)V
    ...
    iput-object p1, p0, Lbpt;->c:Ljava/util/concurrent/Executor;

    iput-object p2, p0, Lbpt;->d:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public static a(Ljava/lang/String;)V
    ...
    sget-object v0, Lbpt;->b:Ljava/lang/String;

    const-string v1, " is not gated and it doesn\'t guarantee the execution order"
    ...
    invoke-static {v0, v1, v2}, Lkxm;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
...
.method public final awaitTermination(JLjava/util/concurrent/TimeUnit;)Z
    ...
    iget-object v0, p0, Lbpt;->d:Ljava/util/concurrent/ScheduledExecutorService;
...
.method public final execute(Ljava/lang/Runnable;)V
    ...
    iget-object v0, p0, Lbpt;->c:Ljava/util/concurrent/Executor;
...
.method public final invokeAll(Ljava/util/Collection;)Ljava/util/List;
    ...
    invoke-static {v0}, Lbpt;->a(Ljava/lang/String;)V
...
.method public final submit(Ljava/lang/Runnable;)Ljava/util/concurrent/Future;
    ...
    invoke-virtual {p0, p1, v0}, Lbpt;->submit(Ljava/lang/Runnable;Ljava/lang/Object;)Ljava/util/concurrent/Future;
...
.method public final submit(Ljava/lang/Runnable;Ljava/lang/Object;)Ljava/util/concurrent/Future;
    ...
    invoke-direct {v0, p1, p2}, Lbps;-><init>(Ljava/lang/Runnable;Ljava/lang/Object;)V

    iget-object p1, p0, Lbpt;->c:Ljava/util/concurrent/Executor;
...
.method public final submit(Ljava/util/concurrent/Callable;)Ljava/util/concurrent/Future;
    ...
    invoke-static {p1, v0}, Lqxl;->a(Ljava/util/concurrent/Callable;Ljava/util/concurrent/Executor;)Lqwl;
