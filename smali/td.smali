...
.method public final a(Landroid/content/Context;Llw;)V
    ...
    iget-object p1, p0, Ltd;->a:Llw;

    if-eqz p1, :cond_0

    iget-object v0, p0, Ltd;->b:Llz;

    if-eqz v0, :cond_0

    invoke-virtual {p1, v0}, Llw;->b(Llz;)Z

    :cond_0
    iput-object p2, p0, Ltd;->a:Llw;
...
.method public final a(Llz;)Z
    ...
    invoke-virtual {p1, v0}, Llz;->e(Z)V
...
.method public final b()V
    ...
    iget-object v0, p0, Ltd;->a:Llw;

    if-eqz v0, :cond_1

    invoke-virtual {v0}, Llw;->size()I
    ...
    iget-object v2, p0, Ltd;->a:Llw;

    invoke-virtual {v2, v1}, Llw;->getItem(I)Landroid/view/MenuItem;

    move-result-object v2

    iget-object v3, p0, Ltd;->b:Llz;
    ...
    invoke-virtual {p0, v0}, Ltd;->a(Llz;)Z
...
.method public final b(Llz;)Z
    ...
    invoke-direct {v1, v4, v5, v6}, Lnz;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v4, v0}, Ltc;-><init>(Landroid/support/v7/widget/Toolbar;)V
    ...
    iget-object p1, p0, Ltd;->c:Landroid/support/v7/widget/Toolbar;
    ...
    iget-object p1, p1, Lmc;->a:Landroid/view/CollapsibleActionView;
