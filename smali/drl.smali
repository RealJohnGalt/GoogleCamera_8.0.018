...
.method public final a(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v3, v0, Ldrr;->c:Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;
    ...
    iget-object v5, v0, Ldrr;->e:Lcom/google/android/apps/camera/bottombar/RoundedThumbnailView;
    ...
    invoke-direct {v4, v0, v2, v1}, Ldrq;-><init>(Ldrr;Lqxb;Lblc;)V

    iget-object v0, v3, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->f:Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionThumbnailView;
    ...
    iget-object p1, v3, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->b:Landroid/animation/ValueAnimator;
    ...
    invoke-virtual {v3}, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->a()Ldry;

    move-result-object p1

    invoke-virtual {p1}, Ldry;->a()Ldrx;

    move-result-object p1

    iput-object p1, v3, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->i:Ldrx;

    :cond_0
    iput-object v4, v3, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->j:Ldrq;
    ...
    iget-object p1, v3, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->i:Ldrx;

    const/high16 v0, 0x3f800000    # 1.0f

    invoke-virtual {p1, v0}, Ldrx;->a(F)F

    move-result p1

    iget-object v1, v3, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->f:Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionThumbnailView;
    ...
    invoke-virtual {p1, v0}, Ldrx;->b(F)Landroid/graphics/PointF;
    ...
    invoke-virtual {p1, v0}, Ldrx;->c(F)F

    move-result p1

    iget-object v1, v3, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionLayout;->f:Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionThumbnailView;

    invoke-virtual {v1, p1}, Lcom/google/android/apps/camera/filmstrip/transition/FilmstripTransitionThumbnailView;->a(F)V

    invoke-static {v0}, Ldrx;->d(F)F
