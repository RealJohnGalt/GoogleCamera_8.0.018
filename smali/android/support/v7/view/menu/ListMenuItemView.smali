...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object v1, Lko;->q:[I

    const/4 v2, 0x0

    invoke-static {v0, p2, v1, p3, v2}, Lsz;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lsz;

    move-result-object p2

    const/4 p3, 0x5

    invoke-virtual {p2, p3}, Lsz;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p2, p3, v0}, Lsz;->f(II)I
    ...
    invoke-virtual {p2, v0}, Lsz;->a(I)Landroid/graphics/drawable/Drawable;
...
.method public final a()Llz;
    ...
    iget-object v0, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Llz;
...
.method public final a(Llz;)V
    ...
    iput-object p1, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Llz;
    ...
    :cond_3
    iget-object v4, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Llz;
    ...
    :cond_a
    :goto_3
    invoke-virtual {p1}, Llz;->d()Z

    move-result v0

    invoke-virtual {p1}, Llz;->c()C

    if-eqz v0, :cond_b

    iget-object v0, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Llz;

    invoke-virtual {v0}, Llz;->d()Z
    ...
    iget-object v5, p0, Landroid/support/v7/view/menu/ListMenuItemView;->a:Llz;

    invoke-virtual {v5}, Llz;->c()C
    ...
    :cond_c
    iget-object v7, v5, Llz;->j:Llw;

    iget-object v7, v7, Llw;->a:Landroid/content/Context;
    ...
    iget-object v9, v5, Llz;->j:Llw;

    iget-object v9, v9, Llw;->a:Landroid/content/Context;
    ...
    invoke-static {v8, v5, v9, v10}, Llz;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    invoke-static {v8, v5, v1, v9}, Llz;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V

    const/4 v9, 0x4

    const v10, 0x7f130013
    ...
    invoke-static {v8, v5, v3, v9}, Llz;->a(Ljava/lang/StringBuilder;IILjava/lang/String;)V
    ...
    :cond_1c
    iget-object p1, p1, Llz;->l:Ljava/lang/CharSequence;
