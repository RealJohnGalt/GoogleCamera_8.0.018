...
.method protected final onDetachedFromWindow()V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ContentFrameLayout;->i:Ljh;

    if-eqz v0, :cond_3

    iget-object v0, v0, Ljh;->a:Ljw;

    iget-object v1, v0, Ljw;->m:Lpc;

    if-eqz v1, :cond_0

    invoke-interface {v1}, Lpc;->i()V
    ...
    iget-object v1, v0, Ljw;->h:Landroid/view/Window;

    invoke-virtual {v1}, Landroid/view/Window;->getDecorView()Landroid/view/View;

    move-result-object v1

    iget-object v2, v0, Ljw;->q:Ljava/lang/Runnable;
    ...
    iput-object v1, v0, Ljw;->p:Landroid/widget/PopupWindow;
