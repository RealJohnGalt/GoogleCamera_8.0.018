...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lhu;

    sget-object p2, Lhu;->a:Lhu;

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Lhu;

    sget-object p2, Lhu;->a:Lhu;

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lhu;

    sget-object p2, Lhu;->a:Lhu;

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Lhu;

    new-instance p2, Lmy;

    invoke-direct {p2, p0}, Lmy;-><init>(Landroid/support/v7/widget/ActionBarOverlayLayout;)V

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->i:Landroid/animation/AnimatorListenerAdapter;

    new-instance p2, Lmz;

    invoke-direct {p2, p0}, Lmz;-><init>(Landroid/support/v7/widget/ActionBarOverlayLayout;)V

    iput-object p2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->z:Ljava/lang/Runnable;

    new-instance p2, Lna;

    invoke-direct {p2, p0}, Lna;-><init>(Landroid/support/v7/widget/ActionBarOverlayLayout;)V
...
.method private static final a(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    iput v0, p0, Lnc;->topMargin:I

    const/4 v0, 0x1

    :cond_1
    iget v1, p0, Lnc;->rightMargin:I
...
.method final a()V
    ...
    :goto_0
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lpd;
...
.method public final a(Landroid/view/Menu;Lmj;)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lpd;

    invoke-interface {v0, p1, p2}, Lpd;->a(Landroid/view/Menu;Lmj;)V
...
.method public final a(Landroid/view/Window$Callback;)V
    ...
    invoke-interface {v0, p1}, Lpd;->a(Landroid/view/Window$Callback;)V
...
.method public final b(I)V
    ...
    :cond_2
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->m:Lpd;

    invoke-interface {p1}, Lpd;->f()V
...
.method public final bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, v1, p1}, Lnc;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
...
.method protected final generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lnc;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {p1, p0}, Lhu;->a(Landroid/view/WindowInsets;Landroid/view/View;)Lhu;
    ...
    invoke-virtual {p1}, Lhu;->b()I

    move-result v2

    invoke-virtual {p1}, Lhu;->c()I

    move-result v3

    invoke-virtual {p1}, Lhu;->d()I
    ...
    invoke-static {p0, p1, v1}, Lhh;->a(Landroid/view/View;Lhu;Landroid/graphics/Rect;)V
    ...
    invoke-virtual {p1, v1, v2, v3, v4}, Lhu;->b(IIII)Lhu;

    move-result-object v1

    iput-object v1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lhu;

    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Lhu;

    invoke-virtual {v2, v1}, Lhu;->equals(Ljava/lang/Object;)Z

    move-result v1

    if-nez v1, :cond_0

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lhu;

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->v:Lhu;
    ...
    :cond_2
    invoke-virtual {p1}, Lhu;->h()Lhu;

    move-result-object p1

    invoke-virtual {p1}, Lhu;->f()Lhu;

    move-result-object p1

    invoke-virtual {p1}, Lhu;->g()Lhu;
...
.method protected final onLayout(ZIIII)V
    ...
    iget v3, v0, Lnc;->leftMargin:I

    add-int/2addr v3, p2

    iget v0, v0, Lnc;->topMargin:I
...
.method protected final onMeasure(II)V
    ...
    iget v2, v0, Lnc;->leftMargin:I

    add-int/2addr v1, v2

    iget v2, v0, Lnc;->rightMargin:I
    ...
    iget v4, v0, Lnc;->topMargin:I

    add-int/2addr v3, v4

    iget v0, v0, Lnc;->bottomMargin:I
    ...
    invoke-static {p0}, Lhh;->p(Landroid/view/View;)I
    ...
    iget-object v6, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->u:Lhu;

    iput-object v6, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lhu;
    ...
    iget-object v4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lhu;

    invoke-virtual {v4, v2, v5, v2, v2}, Lhu;->b(IIII)Lhu;

    move-result-object v2

    iput-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lhu;
    ...
    invoke-virtual {v4}, Lhu;->b()I

    move-result v4

    iget-object v6, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lhu;

    invoke-virtual {v6}, Lhu;->c()I

    move-result v6

    iget-object v7, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lhu;

    invoke-virtual {v7}, Lhu;->d()I

    move-result v7

    add-int/2addr v4, v5

    invoke-static {v2, v4, v6, v7}, Lfm;->a(IIII)Lfm;
    ...
    invoke-direct {v5, v4}, Lhn;-><init>(Lhu;)V

    invoke-static {v2, v5}, Lrpy;->a(Lfm;Lhn;)V

    invoke-static {v5}, Lrpy;->a(Lhn;)Lhu;
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Lhu;

    iget-object v4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lhu;

    invoke-virtual {v2, v4}, Lhu;->equals(Ljava/lang/Object;)Z

    move-result v2

    if-nez v2, :cond_3

    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->w:Lhu;

    iput-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->x:Lhu;

    iget-object v4, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->l:Landroid/support/v7/widget/ContentFrameLayout;

    invoke-static {v4, v2}, Lhh;->b(Landroid/view/View;Lhu;)Lhu;
    ...
    iget v5, v2, Lnc;->leftMargin:I

    iget v6, v2, Lnc;->rightMargin:I
    ...
    iget v5, v2, Lnc;->topMargin:I

    iget v2, v2, Lnc;->bottomMargin:I
...
.method public final onNestedScrollAccepted(Landroid/view/View;Landroid/view/View;I)V
    ...
    invoke-virtual {p1, p3, p2}, Lha;->a(II)V
    ...
    iget-object p1, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:Lnb;

    if-eqz p1, :cond_1

    check-cast p1, Lkn;

    iget-object p2, p1, Lkn;->n:Lle;

    if-eqz p2, :cond_1

    invoke-virtual {p2}, Lle;->b()V

    const/4 p2, 0x0

    iput-object p2, p1, Lkn;->n:Lle;
...
.method public final onWindowSystemUiVisibilityChanged(I)V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:Lnb;
    ...
    :cond_1
    iget-boolean p1, v2, Lkn;->m:Z

    if-nez p1, :cond_3

    iput-boolean v4, v2, Lkn;->m:Z

    invoke-virtual {v2, v4}, Lkn;->e(Z)V
...
.method protected final onWindowVisibilityChanged(I)V
    ...
    iget-object v0, p0, Landroid/support/v7/widget/ActionBarOverlayLayout;->g:Lnb;
