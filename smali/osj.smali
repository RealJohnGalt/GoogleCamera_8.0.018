...
# direct methods
.method public constructor <init>(Lqwl;Losq;)V
    .locals 3
    ...
    iput-object v0, p0, Losj;->b:Lqxb;

    invoke-static {}, Lqxb;->f()Lqxb;

    move-result-object v0

    iput-object v0, p0, Losj;->c:Lqxb;

    invoke-static {}, Lqxb;->f()Lqxb;

    move-result-object v1

    iput-object v1, p0, Losj;->h:Lqxb;

    invoke-static {}, Lqxb;->f()Lqxb;

    move-result-object v1

    iput-object v1, p0, Losj;->d:Lqxb;

    invoke-static {}, Lqxb;->f()Lqxb;

    move-result-object v1

    iput-object v1, p0, Losj;->e:Lqxb;
    ...
    iput-object v1, p0, Losj;->f:Ljava/util/concurrent/ConcurrentLinkedDeque;

    new-instance v1, Ljava/lang/Object;

    invoke-direct {v1}, Ljava/lang/Object;-><init>()V

    iput-object v1, p0, Losj;->j:Ljava/lang/Object;

    const-wide/16 v1, 0x0

    iput-wide v1, p0, Losj;->k:J

    iput-object p2, p0, Losj;->i:Losq;

    iput-object p1, p0, Losj;->a:Lqwl;

    new-instance v1, Losf;

    invoke-direct {v1, p0}, Losf;-><init>(Losj;)V

    invoke-interface {p1, v1, p2}, Lqwl;->a(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V

    new-instance p1, Losg;

    invoke-direct {p1, p0}, Losg;-><init>(Losj;)V

    invoke-virtual {v0, p1, p2}, Lqxb;->a(Ljava/lang/Runnable;Ljava/util/concurrent/Executor;)V
...
.method public final a()V
    ...
    :try_start_0
    iget-object v0, p0, Losj;->j:Ljava/lang/Object;
    ...
    invoke-static {v1, v3}, Losj;->a(Landroid/media/MediaFormat;Ljava/lang/String;)Z

    move-result v1

    iget-object v3, p0, Losj;->h:Lqxb;
    ...
    :goto_0
    iget-object v1, p0, Losj;->f:Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    iget-object v1, v1, Lorx;->b:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object v1, p0, Losj;->h:Lqxb;

    iget-object v3, p0, Losj;->f:Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    iget-object v3, v3, Lorx;->b:Landroid/media/MediaCodec$BufferInfo;
    ...
    iget-object v6, p0, Losj;->f:Ljava/util/concurrent/ConcurrentLinkedDeque;
    ...
    iget-object v1, p0, Losj;->e:Lqxb;

    invoke-virtual {v1, v3}, Lqxb;->b(Ljava/lang/Object;)Z

    :cond_8
    :goto_5
    iget-object v1, p0, Losj;->c:Lqxb;
    ...
    iget-object v4, p0, Losj;->g:Landroid/media/MediaMuxer;

    iget-object v5, v1, Lorx;->b:Landroid/media/MediaCodec$BufferInfo;

    iget-wide v5, v5, Landroid/media/MediaCodec$BufferInfo;->presentationTimeUs:J

    iget-wide v7, p0, Losj;->k:J

    iget-object v9, p0, Losj;->a:Lqwl;

    invoke-static {v9}, Lqxl;->b(Ljava/util/concurrent/Future;)Ljava/lang/Object;
    ...
    invoke-static {v9, v10}, Losj;->a(Landroid/media/MediaFormat;Ljava/lang/String;)Z
    ...
    iget-object v5, v1, Lorx;->a:Ljava/nio/ByteBuffer;
...
.method public final a(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V
    ...
    new-instance p2, Lorx;

    invoke-direct {p2, p1, v6}, Lorx;-><init>(Ljava/nio/ByteBuffer;Landroid/media/MediaCodec$BufferInfo;)V

    iget-object p1, p0, Losj;->i:Losq;

    new-instance v0, Losh;

    invoke-direct {v0, p0, p2}, Losh;-><init>(Losj;Lorx;)V

    invoke-virtual {p1, v0}, Losq;->execute(Ljava/lang/Runnable;)V
...
.method public final close()V
    ...
    iget-object v0, p0, Losj;->i:Losq;

    new-instance v1, Losi;

    invoke-direct {v1, p0}, Losi;-><init>(Losj;)V

    invoke-virtual {v0, v1}, Losq;->execute(Ljava/lang/Runnable;)V
