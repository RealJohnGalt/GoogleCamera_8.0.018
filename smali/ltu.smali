...
.method public final run()V
    ...
    iget-object v0, p0, Lltu;->a:Lltw;

    invoke-virtual {v0}, Lltf;->n()V

    invoke-static {}, Llsz;->a()V

    iget-object v1, v0, Llte;->b:Llti;

    iget-object v1, v1, Llti;->a:Landroid/content/Context;

    invoke-static {v1}, Llus;->a(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v2}, Llte;->b(Ljava/lang/String;)V

    goto :goto_0

    :cond_0
    invoke-static {v1}, Llux;->a(Landroid/content/Context;)Z
    ...
    invoke-virtual {v0, v2}, Llte;->c(Ljava/lang/String;)V

    :cond_1
    :goto_0
    invoke-static {v1}, Lmcj;->a(Ljava/lang/Object;)V

    sget-object v2, Llsp;->a:Ljava/lang/Boolean;

    if-eqz v2, :cond_2

    sget-object v1, Llsp;->a:Ljava/lang/Boolean;
    ...
    invoke-static {v1, v3, v2}, Loim;->a(Landroid/content/Context;Ljava/lang/String;Z)Z
    ...
    sput-object v2, Llsp;->a:Ljava/lang/Boolean;
    ...
    invoke-virtual {v0, v1}, Llte;->b(Ljava/lang/String;)V

    :cond_3
    invoke-virtual {v0}, Llte;->j()Llur;

    move-result-object v1

    invoke-static {}, Llsz;->a()V

    invoke-virtual {v1}, Lltf;->n()V

    iget-wide v2, v1, Llur;->c:J
    ...
    iget-object v2, v1, Llur;->a:Landroid/content/SharedPreferences;
    ...
    iput-wide v6, v1, Llur;->c:J

    goto :goto_2

    :cond_4
    invoke-virtual {v1}, Llte;->k()Lmco;
    ...
    invoke-virtual {v1, v2}, Llte;->b(Ljava/lang/String;)V

    :cond_5
    iput-wide v4, v1, Llur;->c:J
    ...
    invoke-virtual {v0, v1}, Lltw;->d(Ljava/lang/String;)Z
    ...
    invoke-virtual {v0, v1}, Llte;->c(Ljava/lang/String;)V

    invoke-virtual {v0}, Lltw;->s()V
    ...
    :goto_3
    iget-boolean v1, v0, Lltw;->f:Z

    if-nez v1, :cond_a

    iget-object v1, v0, Lltw;->c:Lltq;

    invoke-virtual {v1}, Lltq;->q()Z

    move-result v1

    if-nez v1, :cond_a

    invoke-virtual {v0}, Lltw;->p()V
