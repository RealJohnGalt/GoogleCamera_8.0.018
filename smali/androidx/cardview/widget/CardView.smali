...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v1, p0}, Lwx;-><init>(Landroidx/cardview/widget/CardView;)V

    iput-object v1, p0, Landroidx/cardview/widget/CardView;->f:Lwx;

    sget-object v2, Lww;->a:[I
    ...
    invoke-direct {v0, p1, p3}, Lwy;-><init>(Landroid/content/res/ColorStateList;F)V

    iput-object v0, v1, Lwx;->a:Landroid/graphics/drawable/Drawable;

    iget-object p1, v1, Lwx;->b:Landroidx/cardview/widget/CardView;
    ...
    iget-object p1, v1, Lwx;->a:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1}, Lwx;->a()Z

    move-result p3

    invoke-virtual {v1}, Lwx;->b()Z
    ...
    iget-boolean v2, p1, Lwy;->c:Z

    if-ne v2, p3, :cond_3

    iget-boolean v2, p1, Lwy;->d:Z
    ...
    iput-boolean p3, p1, Lwy;->c:Z

    iput-boolean v0, p1, Lwy;->d:Z

    const/4 p2, 0x0

    invoke-virtual {p1, p2}, Lwy;->a(Landroid/graphics/Rect;)V

    invoke-virtual {p1}, Lwy;->invalidateSelf()V
    ...
    invoke-virtual {v1, v3, v3, v3, v3}, Lwx;->a(IIII)V
    ...
    invoke-static {p2, p1, p3}, Lwz;->b(FFZ)F
    ...
    invoke-static {p2, p1, v0}, Lwz;->a(FFZ)F
    ...
    invoke-virtual {v1, p3, p1, p3, p1}, Lwx;->a(IIII)V
