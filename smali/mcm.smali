...
.field public static volatile c:Lmcm;
...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lmcm;->b:Ljava/lang/Object;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lmcm;->a:Lj$/util/concurrent/ConcurrentHashMap;

    return-void
.end method

.method public static a()Lmcm;
    .locals 2
    ...
    sget-object v0, Lmcm;->b:Ljava/lang/Object;
...
.method public final a(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    ...
    invoke-static {p2}, Lmcm;->a(Landroid/content/ServiceConnection;)Z

    move-result v0

    if-eqz v0, :cond_0

    iget-object v0, p0, Lmcm;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    invoke-static {p1, v0}, Lmcm;->b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p1, p0, Lmcm;->a:Lj$/util/concurrent/ConcurrentHashMap;
    ...
    :cond_0
    invoke-static {p1, p2}, Lmcm;->b(Landroid/content/Context;Landroid/content/ServiceConnection;)V
...
.method public final a(Landroid/content/Context;Ljava/lang/String;Landroid/content/Intent;Landroid/content/ServiceConnection;I)Z
    ...
    :try_start_0
    invoke-static {p1}, Lmcw;->b(Landroid/content/Context;)Lmcv;

    move-result-object v3

    invoke-virtual {v3, v0, v2}, Lmcv;->a(Ljava/lang/String;I)Landroid/content/pm/ApplicationInfo;
    ...
    :cond_1
    :goto_0
    invoke-static {p4}, Lmcm;->a(Landroid/content/ServiceConnection;)Z
    ...
    iget-object p2, p0, Lmcm;->a:Lj$/util/concurrent/ConcurrentHashMap;
