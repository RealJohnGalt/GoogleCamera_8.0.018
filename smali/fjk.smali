...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Lfjk;->j:Landroid/net/Uri;
...
.method public constructor <init>(Landroid/content/Context;Ljava/util/concurrent/Executor;)V
    ...
    iput-boolean v0, p0, Lfjk;->b:Z

    invoke-static {p1}, Lmjd;->a(Landroid/content/Context;)Llws;

    move-result-object p1

    iput-object p1, p0, Lfjk;->i:Llws;

    iput-object p2, p0, Lfjk;->k:Ljava/util/concurrent/Executor;
...
.method public static a(Landroid/content/Context;)Z
    ...
    :try_start_0
    sget-object v3, Lfjk;->j:Landroid/net/Uri;
    ...
    invoke-static {v4, v5, v3}, Lkxm;->b(Ljava/lang/String;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_2
...
.method private final b()V
    ...
    :try_start_0
    iput-boolean v0, p0, Lfjk;->h:Z

    iget-boolean v0, p0, Lfjk;->b:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
    ...
    invoke-static {v1, v2}, Lmcj;->a(Ljava/lang/String;Ljava/lang/Object;)V

    new-instance v2, Llyy;

    invoke-direct {v2, p0, v1}, Llyy;-><init>(Ljava/lang/Object;Ljava/lang/String;)V

    invoke-virtual {v0, v2}, Llws;->b(Llyy;)V
    :try_end_1
    ...
    :try_start_2
    sget-object v1, Lfjk;->a:Ljava/lang/String;
...
.method public static final b(Landroid/location/Location;)Z
    ...
    sget-object p0, Lfjk;->a:Ljava/lang/String;
    ...
    invoke-static {v1, v2}, Loib;->d(J)F
    ...
    invoke-static {v1, p0}, Lkxm;->b(Ljava/lang/String;Ljava/lang/String;)V
...
.method public final a()Lqwl;
    ...
    iget-object v1, p0, Lfjk;->e:Landroid/location/Location;
    ...
    iget-object v2, p0, Lfjk;->e:Landroid/location/Location;

    goto :goto_0

    :cond_0
    iput-object v2, p0, Lfjk;->e:Landroid/location/Location;
    ...
    :cond_1
    iget-object v1, p0, Lfjk;->i:Llws;

    invoke-virtual {v1}, Llws;->b()Lmmh;

    move-result-object v1

    iget-object v2, p0, Lfjk;->k:Ljava/util/concurrent/Executor;

    new-instance v3, Lfji;

    invoke-direct {v3, p0, v0}, Lfji;-><init>(Lfjk;Lqxb;)V
...
.method public final a(Z)V
    ...
    sget-object p1, Lfjk;->a:Ljava/lang/String;
    ...
    iput-boolean p1, p0, Lfjk;->h:Z

    monitor-exit p0
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    iget-object p1, p0, Lfjk;->i:Llws;

    invoke-virtual {p1}, Llws;->b()Lmmh;

    move-result-object p1

    iget-object v0, p0, Lfjk;->k:Ljava/util/concurrent/Executor;

    new-instance v1, Lfjj;

    invoke-direct {v1, p0}, Lfjj;-><init>(Lfjk;)V

    invoke-virtual {p1, v0, v1}, Lmmh;->a(Ljava/util/concurrent/Executor;Lmlz;)V
