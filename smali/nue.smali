...
# direct methods
.method public constructor <init>(Landroid/hardware/SensorManager;Lncr;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p1, p0, Lnue;->c:Landroid/hardware/SensorManager;
    ...
    iput-object p1, p0, Lnue;->a:Lncr;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, Lnue;->d:Ljava/util/Set;
...
.method private final declared-synchronized a()V
    ...
    invoke-direct {v1, v0}, Lnuu;-><init>(Landroid/hardware/HardwareBuffer;)V
    :try_end_3
    ...
    invoke-direct {v3, v1}, Lnuh;-><init>(Lnuu;)V
    :try_end_4
    .catchall {:try_start_4 .. :try_end_4} :catchall_3

    :try_start_5
    iget-object v4, p0, Lnue;->c:Landroid/hardware/SensorManager;
    ...
    :cond_1
    :try_start_8
    iget-object v0, p0, Lnue;->c:Landroid/hardware/SensorManager;
    ...
    invoke-direct {v4, v1, v2, v0, v3}, Lnud;-><init>(Lnuu;Landroid/hardware/SensorDirectChannel;Landroid/hardware/Sensor;Lnuh;)V

    iput-object v4, p0, Lnue;->b:Lnud;
    :try_end_c
    ...
    :goto_1
    :try_start_d
    iget-object v3, p0, Lnue;->a:Lncr;

    const-string v4, "Failed to start direct gyro provider: Creating direct channel threw an exception."

    invoke-interface {v3, v4, v0}, Lncr;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_d
    ...
    invoke-interface {v1, v2, v0}, Lncr;->b(Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_e
...
.method private final declared-synchronized b()V
    ...
    iget-object v1, v0, Lnud;->b:Landroid/hardware/SensorDirectChannel;

    iget-object v2, v0, Lnud;->c:Landroid/hardware/Sensor;
    ...
    iget-object v0, v0, Lnud;->a:Lnuu;

    invoke-virtual {v0}, Lnuu;->a()V

    const/4 v0, 0x0

    iput-object v0, p0, Lnue;->b:Lnud;
    :try_end_0
...
# virtual methods
.method public final declared-synchronized a(Ljava/lang/String;)Lnum;
    .locals 4

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lnue;->d:Ljava/util/Set;
    ...
    invoke-interface {v1}, Lnum;->a()Ljava/lang/String;
    ...
    invoke-direct {v0, p0, p1}, Lnuc;-><init>(Lnue;Ljava/lang/String;)V

    iget-object p1, p0, Lnue;->d:Ljava/util/Set;

    invoke-interface {p1, v0}, Ljava/util/Set;->add(Ljava/lang/Object;)Z

    iget-object p1, p0, Lnue;->a:Lncr;

    iget-object v1, v0, Lnuc;->a:Ljava/lang/String;
...
.method public final declared-synchronized a(Lnum;)V
    ...
    iget-object p1, p1, Lnuc;->a:Ljava/lang/String;

    iget-object v1, p0, Lnue;->d:Ljava/util/Set;
