...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p2}, Ldse;-><init>()V

    iput-object p2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Ldsd;
    ...
    invoke-direct {p2, v1}, Ldsg;-><init>(Landroid/graphics/drawable/ShapeDrawable;)V

    iput-object p2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Ldsf;
...
.method constructor <init>(Landroid/content/Context;Ldsd;Ldsf;)V
    .locals 0
    ...
    iput-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Ldsf;
...
.method protected final onDraw(Landroid/graphics/Canvas;)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Ldsd;

    invoke-interface {v0, p1}, Ldsd;->a(Landroid/graphics/Canvas;)V

    iget-object v0, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Ldsf;

    invoke-interface {v0, p1}, Ldsf;->a(Landroid/graphics/Canvas;)V
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p2, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->e:Llhx;
    ...
    invoke-static {p3}, Llas;->c(Landroid/content/Context;)I
    ...
    invoke-static {p4, p3, p5, v0}, Llhx;->a(IZII)Llhx;

    move-result-object p3

    iput-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->e:Llhx;
    ...
    invoke-static {p3}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a(Llhx;)I

    move-result p3

    invoke-static {p2}, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a(Llhx;)I
    ...
    :cond_2
    :goto_0
    sget-object p2, Lnby;->b:Lnby;

    goto :goto_1

    :cond_3
    sget-object p2, Lnby;->c:Lnby;

    goto :goto_1

    :cond_4
    sget-object p2, Lnby;->d:Lnby;
    ...
    invoke-virtual {p2}, Lnby;->ordinal()I
...
.method protected final onSizeChanged(IIII)V
    ...
    iget-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->a:Ldsd;

    invoke-interface {p3, p1, p2}, Ldsd;->a(II)V

    iget-object p3, p0, Lcom/google/android/apps/camera/focusindicator/FocusIndicatorRingView;->b:Ldsf;

    invoke-interface {p3, p1, p2}, Ldsf;->a(II)V
