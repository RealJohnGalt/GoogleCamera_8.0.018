...
.method private final declared-synchronized b()Lfby;
    .locals 3

    monitor-enter p0

    :try_start_0
    iget-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lfby;
    ...
    invoke-interface {v0}, Leug;->b()Lesx;
    ...
    invoke-direct {v1, v2}, Lfbz;-><init>(Landroid/app/Activity;)V

    invoke-interface {v0, v1}, Lesx;->a(Lfbz;)Lfcb;

    move-result-object v0

    invoke-interface {v0}, Lfcb;->a()Lfby;

    move-result-object v0

    iput-object v0, p0, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b:Lfby;

    invoke-virtual {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->getContext()Landroid/content/Context;

    move-result-object v1

    invoke-virtual {v0, v1}, Lfby;->a(Landroid/content/Context;)V
...
.method public final queryNonIndexableKeys([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    invoke-direct {p0}, Lcom/google/android/apps/camera/legacy/app/settings/CameraSearchIndexablesProvider;->b()Lfby;
...
.method public final queryRawData([Ljava/lang/String;)Landroid/database/Cursor;
    ...
    iget-object p1, p1, Lfby;->m:Lqeu;

    check-cast p1, Lpzt;

    iget-object v1, p1, Lpzt;->d:Ljava/util/Collection;

    if-nez v1, :cond_0

    new-instance v1, Lpzs;

    invoke-direct {v1, p1}, Lpzs;-><init>(Lpzt;)V

    iput-object v1, p1, Lpzt;->d:Ljava/util/Collection;
