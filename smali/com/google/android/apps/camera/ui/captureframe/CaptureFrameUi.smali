...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {v1, p0, p2, v0, p1}, Lkaj;-><init>(Lcom/google/android/apps/camera/ui/captureframe/CaptureFrameUi;Landroid/graphics/Paint;IF)V

    new-instance v0, Lkaj;

    const/4 v2, 0x2

    invoke-direct {v0, p0, p2, v2, p1}, Lkaj;-><init>(Lcom/google/android/apps/camera/ui/captureframe/CaptureFrameUi;Landroid/graphics/Paint;IF)V

    new-instance v2, Lkaj;

    const/4 v3, 0x3

    invoke-direct {v2, p0, p2, v3, p1}, Lkaj;-><init>(Lcom/google/android/apps/camera/ui/captureframe/CaptureFrameUi;Landroid/graphics/Paint;IF)V

    new-instance v3, Lkaj;

    const/4 v4, 0x4

    invoke-direct {v3, p0, p2, v4, p1}, Lkaj;-><init>(Lcom/google/android/apps/camera/ui/captureframe/CaptureFrameUi;Landroid/graphics/Paint;IF)V

    invoke-static {v1, v0, v2, v3}, Lqcr;->a(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Lqcr;
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-direct {v1, p0, p1}, Lkai;-><init>(Lcom/google/android/apps/camera/ui/captureframe/CaptureFrameUi;Landroid/graphics/Canvas;)V
