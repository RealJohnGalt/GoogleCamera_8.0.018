...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p1, p0}, Llcw;-><init>(Lcom/google/android/apps/camera/ui/views/CaptureAnimationOverlay;)V
...
.method public final a()V
    ...
    invoke-virtual/range {v0 .. v6}, Lcom/google/android/apps/camera/ui/views/CaptureAnimationOverlay;->a(JJFLandroid/animation/AnimatorListenerAdapter;)V

    return-void
.end method

.method public final a(JJFLandroid/animation/AnimatorListenerAdapter;)V
    .locals 4
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/ui/views/CaptureAnimationOverlay;->j:Landroid/animation/ValueAnimator$AnimatorUpdateListener;
    ...
    iget-object p1, p0, Lcom/google/android/apps/camera/ui/views/CaptureAnimationOverlay;->g:Landroid/view/animation/Interpolator;

    invoke-virtual {v1, p1}, Landroid/animation/ValueAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    iget-object p1, p0, Lcom/google/android/apps/camera/ui/views/CaptureAnimationOverlay;->g:Landroid/view/animation/Interpolator;

    invoke-virtual {p5, p1}, Landroid/animation/ValueAnimator;->setInterpolator(Landroid/animation/TimeInterpolator;)V

    new-instance p1, Llcx;

    invoke-direct {p1, p0, p6, p5}, Llcx;-><init>(Lcom/google/android/apps/camera/ui/views/CaptureAnimationOverlay;Landroid/animation/AnimatorListenerAdapter;Landroid/animation/ValueAnimator;)V
    ...
    invoke-direct {p1, p0, p6}, Llcy;-><init>(Lcom/google/android/apps/camera/ui/views/CaptureAnimationOverlay;Landroid/animation/AnimatorListenerAdapter;)V
...
.method public final a(Z)V
    ...
    invoke-direct {v1, p0, p1}, Llcz;-><init>(Lcom/google/android/apps/camera/ui/views/CaptureAnimationOverlay;Z)V
