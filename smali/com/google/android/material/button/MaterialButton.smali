...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {v0, v1, v7, v8}, Lns;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-static/range {v1 .. v6}, Lprs;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III[I)Landroid/content/res/TypedArray;
    ...
    invoke-static {v2, v4}, Lprz;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;
    ...
    invoke-static {v2, v1, v4}, Lqpa;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v2, v1, v4}, Lqpa;->b(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v11, v7, v8, v9}, Lpsr;->a(Landroid/content/Context;Landroid/util/AttributeSet;II)Lpsq;

    move-result-object v2

    invoke-virtual {v2}, Lpsq;->a()Lpsr;

    move-result-object v2

    new-instance v5, Lpoy;

    invoke-direct {v5, v0, v2}, Lpoy;-><init>(Lcom/google/android/material/button/MaterialButton;Lpsr;)V

    iput-object v5, v0, Lcom/google/android/material/button/MaterialButton;->d:Lpoy;
    ...
    iget-object v7, v5, Lpoy;->b:Lpsr;

    int-to-float v6, v6

    invoke-virtual {v7, v6}, Lpsr;->a(F)Lpsr;

    move-result-object v6

    invoke-virtual {v5, v6}, Lpoy;->a(Lpsr;)V
    ...
    invoke-static {v6, v7}, Lprz;->a(ILandroid/graphics/PorterDuff$Mode;)Landroid/graphics/PorterDuff$Mode;

    move-result-object v6

    iput-object v6, v5, Lpoy;->i:Landroid/graphics/PorterDuff$Mode;

    iget-object v6, v5, Lpoy;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    invoke-static {v6, v1, v7}, Lqpa;->a(Landroid/content/Context;Landroid/content/res/TypedArray;I)Landroid/content/res/ColorStateList;

    move-result-object v6

    iput-object v6, v5, Lpoy;->j:Landroid/content/res/ColorStateList;
    ...
    iput-object v6, v5, Lpoy;->k:Landroid/content/res/ColorStateList;
    ...
    iput-object v6, v5, Lpoy;->l:Landroid/content/res/ColorStateList;
    ...
    invoke-static {v6}, Lhh;->i(Landroid/view/View;)I

    move-result v6

    iget-object v7, v5, Lpoy;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-virtual {v7}, Lcom/google/android/material/button/MaterialButton;->getPaddingTop()I

    move-result v7

    iget-object v8, v5, Lpoy;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-static {v8}, Lhh;->j(Landroid/view/View;)I

    move-result v8

    iget-object v9, v5, Lpoy;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    invoke-virtual {v5}, Lpoy;->a()V

    goto/16 :goto_0

    :cond_1
    iget-object v11, v5, Lpoy;->a:Lcom/google/android/material/button/MaterialButton;

    new-instance v12, Lpsm;

    iget-object v13, v5, Lpoy;->b:Lpsr;

    invoke-direct {v12, v13}, Lpsm;-><init>(Lpsr;)V

    iget-object v13, v5, Lpoy;->a:Lcom/google/android/material/button/MaterialButton;

    invoke-virtual {v13}, Lcom/google/android/material/button/MaterialButton;->getContext()Landroid/content/Context;

    move-result-object v13

    invoke-virtual {v12, v13}, Lpsm;->a(Landroid/content/Context;)V

    iget-object v13, v5, Lpoy;->j:Landroid/content/res/ColorStateList;

    invoke-virtual {v12, v13}, Landroid/graphics/drawable/Drawable;->setTintList(Landroid/content/res/ColorStateList;)V

    iget-object v13, v5, Lpoy;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    :cond_2
    iget v13, v5, Lpoy;->h:I

    int-to-float v13, v13

    iget-object v14, v5, Lpoy;->k:Landroid/content/res/ColorStateList;

    invoke-virtual {v12, v13, v14}, Lpsm;->a(FLandroid/content/res/ColorStateList;)V

    new-instance v13, Lpsm;

    iget-object v14, v5, Lpoy;->b:Lpsr;

    invoke-direct {v13, v14}, Lpsm;-><init>(Lpsr;)V

    invoke-virtual {v13, v10}, Lpsm;->setTint(I)V

    iget v14, v5, Lpoy;->h:I

    int-to-float v14, v14

    invoke-virtual {v13, v14, v10}, Lpsm;->a(FI)V

    new-instance v14, Lpsm;

    iget-object v15, v5, Lpoy;->b:Lpsr;

    invoke-direct {v14, v15}, Lpsm;-><init>(Lpsr;)V

    iput-object v14, v5, Lpoy;->m:Landroid/graphics/drawable/Drawable;

    iget-object v14, v5, Lpoy;->m:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v14, v3}, Landroid/graphics/drawable/Drawable;->setTint(I)V

    new-instance v3, Landroid/graphics/drawable/RippleDrawable;

    iget-object v14, v5, Lpoy;->l:Landroid/content/res/ColorStateList;

    invoke-static {v14}, Lpse;->a(Landroid/content/res/ColorStateList;)Landroid/content/res/ColorStateList;
    ...
    iget v12, v5, Lpoy;->c:I

    iget v13, v5, Lpoy;->e:I

    iget v4, v5, Lpoy;->d:I

    iget v10, v5, Lpoy;->f:I
    ...
    iget-object v4, v5, Lpoy;->m:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v3, v5, Lpoy;->p:Landroid/graphics/drawable/LayerDrawable;

    iget-object v2, v5, Lpoy;->p:Landroid/graphics/drawable/LayerDrawable;

    invoke-super {v11, v2}, Lns;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V

    invoke-virtual {v5}, Lpoy;->b()Lpsm;
    ...
    invoke-virtual {v2, v3}, Lpsm;->c(F)V

    :cond_3
    :goto_0
    iget-object v2, v5, Lpoy;->a:Lcom/google/android/material/button/MaterialButton;
    ...
    invoke-static {v2, v6, v7, v8, v9}, Lhh;->a(Landroid/view/View;IIII)V
...
.method private final a(II)V
    ...
    invoke-static {p0}, Lhh;->j(Landroid/view/View;)I
    ...
    invoke-static {p0}, Lhh;->i(Landroid/view/View;)I
...
.method private final g()Z
    ...
    iget-object v0, p0, Lcom/google/android/material/button/MaterialButton;->d:Lpoy;

    if-eqz v0, :cond_0

    iget-boolean v0, v0, Lpoy;->n:Z
...
.method public final a(Landroid/content/res/ColorStateList;)V
    ...
    iget-object v1, v0, Lpoy;->j:Landroid/content/res/ColorStateList;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Lpoy;->j:Landroid/content/res/ColorStateList;

    invoke-virtual {v0}, Lpoy;->b()Lpsm;
    ...
    iget-object v0, v0, Lpoy;->j:Landroid/content/res/ColorStateList;
...
.method public final a(Landroid/graphics/PorterDuff$Mode;)V
    ...
    iget-object v1, v0, Lpoy;->i:Landroid/graphics/PorterDuff$Mode;

    if-eq v1, p1, :cond_1

    iput-object p1, v0, Lpoy;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object p1, v0, Lpoy;->i:Landroid/graphics/PorterDuff$Mode;
    ...
    iget-object v0, v0, Lpoy;->i:Landroid/graphics/PorterDuff$Mode;
...
.method public final a(Lpsr;)V
    ...
    invoke-virtual {v0, p1}, Lpoy;->a(Lpsr;)V
...
.method protected onAttachedToWindow()V
    ...
    invoke-super {p0}, Lns;->onAttachedToWindow()V
...
.method protected final onCreateDrawableState(I)[I
    ...
    invoke-super {p0, p1}, Lns;->onCreateDrawableState(I)[I
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    invoke-super {p0, p1}, Lns;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
...
.method public final onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
    ...
    invoke-super {p0, p1}, Lns;->onInitializeAccessibilityNodeInfo(Landroid/view/accessibility/AccessibilityNodeInfo;)V
...
.method public final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    instance-of v0, p1, Lpox;

    if-nez v0, :cond_0

    invoke-super {p0, p1}, Lns;->onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    invoke-super {p0, v0}, Lns;->onRestoreInstanceState(Landroid/os/Parcelable;)V

    iget-boolean p1, p1, Lpox;->a:Z
...
.method public final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-super {p0}, Lns;->onSaveInstanceState()Landroid/os/Parcelable;

    move-result-object v0

    new-instance v1, Lpox;

    invoke-direct {v1, v0}, Lpox;-><init>(Landroid/os/Parcelable;)V

    iget-boolean v0, p0, Lcom/google/android/material/button/MaterialButton;->m:Z

    iput-boolean v0, v1, Lpox;->a:Z
...
.method protected final onSizeChanged(IIII)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lns;->onSizeChanged(IIII)V
...
.method protected final onTextChanged(Ljava/lang/CharSequence;III)V
    ...
    invoke-super {p0, p1, p2, p3, p4}, Lns;->onTextChanged(Ljava/lang/CharSequence;III)V
...
.method public final performClick()Z
    ...
    invoke-super {p0}, Lns;->performClick()Z
...
.method public final setBackground(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {p0, p1}, Lns;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public final setBackgroundColor(I)V
    ...
    invoke-virtual {v0, p1}, Lpsm;->setTint(I)V

    :cond_0
    return-void

    :cond_1
    invoke-super {p0, p1}, Lns;->setBackgroundColor(I)V
...
.method public final setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    invoke-virtual {v0}, Lpoy;->a()V

    invoke-super {p0, p1}, Lns;->setBackgroundDrawable(Landroid/graphics/drawable/Drawable;)V
...
.method public final setElevation(F)V
    ...
    invoke-super {p0, p1}, Lns;->setElevation(F)V
