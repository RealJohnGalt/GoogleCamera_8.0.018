...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2}, Lpny;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;)V

    sget-object v0, Lpnz;->a:[I
...
.method static final b(Ljava/util/List;)Lpnv;
    .locals 4
...
.method public final bridge synthetic a(Ljava/util/List;)Landroid/view/View;
    ...
    invoke-static {p1}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->b(Ljava/util/List;)Lpnv;
...
.method public final a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)V
    ...
    instance-of p2, p2, Lpnv;

    if-eqz p2, :cond_0

    sget-object p2, Lhw;->b:Lhw;

    invoke-virtual {p2}, Lhw;->a()I

    move-result p2

    invoke-static {p1, p2}, Lhh;->c(Landroid/view/View;I)V

    sget-object p2, Lhw;->c:Lhw;
...
.method public final bridge synthetic a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)Z
    ...
    invoke-virtual {p0, v2}, Lpny;->a(Ljava/util/List;)Landroid/view/View;
    ...
    invoke-static {v2}, Lhh;->r(Landroid/view/View;)Z

    move-result v1

    if-eqz v1, :cond_2

    iget-object v1, p1, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e:Lhu;
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0, v2}, Lpny;->f(Landroid/view/View;)I
...
.method public final a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;)Z
    ...
    invoke-static {v0}, Lcom/google/android/material/appbar/AppBarLayout$ScrollingViewBehavior;->b(Ljava/util/List;)Lpnv;
...
.method public final a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-virtual {p0, p3}, Lpny;->g(Landroid/view/View;)I
