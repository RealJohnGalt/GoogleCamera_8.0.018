...
.method private static requestFeatures(Landroid/content/Context;J[I[ILandroid/app/PendingIntent;)V
    ...
    invoke-static {p3}, Lrjj;->a([I)[Lrjj;

    move-result-object p3

    invoke-static {p4}, Lrjj;->a([I)[Lrjj;
    ...
    invoke-direct {v0, v1, v2}, Lrjk;-><init>(J)V
    ...
    sget-object v2, Lriy;->a:Landroid/content/ComponentName;
    ...
    invoke-virtual {v0, v6}, Lrjk;->a(Lrjj;)Z

    move-result v7

    if-nez v7, :cond_0

    iget-object v6, v6, Lrjj;->d:Ljava/lang/String;
    ...
    invoke-virtual {v0, v3}, Lrjk;->a(Lrjj;)Z

    move-result v5

    if-nez v5, :cond_3

    iget-object v3, v3, Lrjj;->d:Ljava/lang/String;
