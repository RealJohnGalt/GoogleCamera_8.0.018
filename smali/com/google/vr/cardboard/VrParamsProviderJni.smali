...
.method private static readDeviceParams(Landroid/content/Context;)[B
    ...
    invoke-interface {p0}, Lriv;->a()Lrjm;
...
.method private static readDisplayParams(Landroid/content/Context;J)V
    ...
    invoke-static {v0}, Lrix;->a(Lrjn;)F
    ...
    invoke-interface {v2}, Lriv;->b()Lrjn;

    move-result-object v3

    invoke-interface {v2}, Lriv;->d()V

    invoke-static {p0}, Lrix;->b(Landroid/content/Context;)Landroid/view/Display;

    move-result-object v2

    invoke-static {v2}, Lrix;->a(Landroid/view/Display;)Landroid/util/DisplayMetrics;
    ...
    :cond_2
    invoke-static {v3}, Lrix;->a(Lrjn;)F
    ...
    invoke-static {v2}, Lrid;->a(Ljava/lang/Object;)Lrid;
    ...
    invoke-virtual {v0, p0}, Lrid;->a(Ljava/lang/String;)I

    move-result p0

    const-string v1, "getSafeInsetBottom"

    invoke-virtual {v0, v1}, Lrid;->a(Ljava/lang/String;)I
...
.method private static readSdkConfigurationParams(Landroid/content/Context;)[B
    ...
    invoke-static {p0}, Lrji;->a(Landroid/content/Context;)Lqmb;
...
.method private static readUserPrefs(Landroid/content/Context;)[B
    ...
    invoke-interface {p0}, Lriv;->c()Lrjo;
...
.method private static writeDeviceParams(Landroid/content/Context;[B)Z
    ...
    invoke-static {v1, p1, v0}, Lrcg;->a(Lrcg;[BLrbt;)Lrcg;
    ...
    :goto_0
    invoke-interface {p0, p1}, Lriv;->a(Lrjm;)Z
