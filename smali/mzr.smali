...
.method public static a(JLjava/util/concurrent/atomic/AtomicLong;)Z
    .locals 6
...
# virtual methods
.method public final a(IJLjava/util/concurrent/atomic/AtomicLong;Lqwl;)V
    .locals 9
    ...
    invoke-static {p1}, Lnap;->b(I)Ljava/lang/String;
    ...
    invoke-static {p2, p3, p4}, Lmzr;->a(JLjava/util/concurrent/atomic/AtomicLong;)Z
    ...
    sget-object v1, Lojq;->DcKpN:Ljava/lang/String;
    ...
    invoke-interface {p5, v0, v1, v2}, Lqwl;->get(JLjava/util/concurrent/TimeUnit;)Ljava/lang/Object;
    :try_end_0
    .catch Ljava/lang/InterruptedException; {:try_start_0 .. :try_end_0} :catch_2
    .catch Ljava/util/concurrent/ExecutionException; {:try_start_0 .. :try_end_0} :catch_1
    .catch Ljava/util/concurrent/TimeoutException; {:try_start_0 .. :try_end_0} :catch_0
    ...
    invoke-virtual {p2, p3}, Lqxb;->b(Ljava/lang/Object;)Z

    goto :goto_3

    :cond_2
    invoke-direct {p0}, Lmzr;->a()V
