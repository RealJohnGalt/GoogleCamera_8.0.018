...
.method public constructor <init>(Loac;)V
    ...
    iput-object p1, p0, Loab;->b:Ljava/util/List;
...
.method public final declared-synchronized a(Loaj;)V
    ...
    iget-object v0, p0, Loab;->b:Ljava/util/List;
...
.method public final declared-synchronized close()V
    ...
    iget-object v3, p0, Loab;->b:Ljava/util/List;
    ...
    iget-object v6, v4, Lobb;->a:Loay;

    invoke-interface {v6}, Loay;->j()Loau;

    move-result-object v6

    iget-object v7, p0, Loab;->a:Loac;

    iget-object v7, v7, Loac;->c:Lnde;
    ...
    iget-object v7, v7, Loac;->a:Landroid/content/Context;

    invoke-virtual {v6, v7}, Loau;->a(Landroid/content/Context;)Ljava/io/File;

    move-result-object v7

    iget-boolean v8, v4, Lobb;->b:Z
    :try_end_1
    ...
    :try_start_2
    iget-object v8, p0, Loab;->a:Loac;

    iget-object v8, v8, Loac;->d:Lncr;

    const-string v9, "Deleting "

    iget-object v10, v4, Lobb;->a:Loay;

    invoke-interface {v10}, Loay;->j()Loau;

    move-result-object v10

    invoke-virtual {v10}, Loau;->a()Ljava/lang/String;
    ...
    invoke-interface {v6}, Loay;->a()Landroid/net/Uri;
    ...
    :cond_2
    iget-object v4, p0, Loab;->a:Loac;

    iget-object v4, v4, Loac;->d:Lncr;
    ...
    invoke-interface {v4, v6}, Lncr;->f(Ljava/lang/String;)V

    :cond_3
    :goto_2
    iget-object v4, p0, Loab;->a:Loac;

    iget-object v4, v4, Loac;->c:Lnde;
    ...
    :try_start_3
    iget-object v6, p0, Loab;->a:Loac;

    iget-object v6, v6, Loac;->d:Lncr;
    ...
    invoke-interface {v6, v5, v4}, Lncr;->c(Ljava/lang/String;Ljava/lang/Throwable;)V

    goto/16 :goto_0

    :cond_4
    iget-object v8, v4, Lobb;->c:Loau;
    ...
    iget-object v9, v4, Lobb;->a:Loay;

    invoke-interface {v9}, Loay;->j()Loau;

    move-result-object v9

    invoke-virtual {v9}, Loau;->a()Ljava/lang/String;

    move-result-object v9

    iget-object v11, v4, Lobb;->c:Loau;

    invoke-virtual {v11}, Loau;->a()Ljava/lang/String;
    ...
    iget-object v9, p0, Loab;->a:Loac;

    iget-object v9, v9, Loac;->a:Landroid/content/Context;
    ...
    iget-object v11, p0, Loab;->a:Loac;

    iget-object v11, v11, Loac;->d:Lncr;

    invoke-direct {v7, v9, v8, v11}, Loba;-><init>(Ljava/io/File;Loau;Lncr;)V

    invoke-virtual {v6, v7}, Loat;->a(Loai;)V
    :try_end_5
    ...
    invoke-interface {v9, v5, v6}, Lncr;->c(Ljava/lang/String;Ljava/lang/Throwable;)V

    move-object v6, v8

    :goto_5
    iget-object v5, p0, Loab;->a:Loac;

    iget-object v5, v5, Loac;->c:Lnde;
    ...
    :goto_6
    iget-object v5, v4, Lobb;->a:Loay;

    invoke-interface {v5}, Loay;->j()Loau;

    move-result-object v5

    invoke-virtual {v5}, Loau;->b()Z
    ...
    iget-object v11, v6, Loau;->c:Ljava/lang/String;

    const-string v12, "_data"

    invoke-virtual {v8, v12, v9}, Loap;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v9, v12, v13}, Loap;->a(Ljava/lang/String;J)V

    const/4 v9, 0x0

    sget-object v9, Landroidx/preference/util/Field;->zeSgSoXPWJ:Ljava/lang/String;

    invoke-virtual {v8, v9, v10}, Loap;->a(Ljava/lang/String;Ljava/lang/String;)V

    const-string v9, "title"

    invoke-virtual {v8, v9, v11}, Loap;->a(Ljava/lang/String;Ljava/lang/String;)V
    ...
    invoke-virtual {v8, v9, v10, v11}, Loap;->a(Ljava/lang/String;J)V
    ...
    iput-object v6, v4, Lobb;->d:Loaq;

    invoke-virtual {v6}, Loaq;->b()Landroid/content/ContentValues;
    ...
    :cond_b
    iget-object v3, p0, Loab;->a:Loac;

    iget-object v3, v3, Loac;->c:Lnde;
    ...
    iget-object v3, v3, Loac;->b:Landroid/content/ContentResolver;
    ...
    iget-object v1, p0, Loab;->b:Ljava/util/List;
    ...
    iget-boolean v2, v1, Lobb;->b:Z

    if-eqz v2, :cond_e

    iget-object v0, v1, Lobb;->a:Loay;

    sget-object v2, Landroid/net/Uri;->EMPTY:Landroid/net/Uri;

    invoke-interface {v0, v2}, Loay;->a(Landroid/net/Uri;)V

    iget-object v0, v1, Lobb;->a:Loay;

    invoke-interface {v0}, Loay;->b()V

    goto :goto_d

    :cond_e
    iget-object v2, v1, Lobb;->a:Loay;

    iget-object v4, v0, Landroid/content/ContentProviderResult;->uri:Landroid/net/Uri;

    invoke-interface {v2, v4}, Loay;->a(Landroid/net/Uri;)V

    iget-object v2, v1, Lobb;->a:Loay;

    iget-object v4, v1, Lobb;->d:Loaq;

    invoke-interface {v2}, Loay;->b()V

    iget-object v2, p0, Loab;->a:Loac;

    iget-object v2, v2, Loac;->d:Lncr;

    iget-object v1, v1, Lobb;->a:Loay;
    ...
    :cond_f
    iget-object v0, p0, Loab;->a:Loac;

    iget-object v0, v0, Loac;->c:Lnde;
