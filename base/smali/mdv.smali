...
.method public static a(Lmdu;Landroid/os/Parcel;I)V
    .locals 4
    ...
    iget-object v1, p0, Lmdu;->b:Landroid/os/Bundle;
    ...
    iget-object v1, p0, Lmdu;->d:Landroid/app/ApplicationErrorReport;

    const/4 v2, 0x6

    invoke-static {p1, v2, v1, p2}, Lmcn;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    iget-object v1, p0, Lmdu;->e:Ljava/lang/String;

    const/4 v2, 0x7

    invoke-static {p1, v2, v1, v3}, Lmcn;->a(Landroid/os/Parcel;ILjava/lang/String;Z)V

    iget-object v1, p0, Lmdu;->f:Lcom/google/android/gms/common/data/BitmapTeleporter;
    ...
    iget-object v1, p0, Lmdu;->h:Ljava/util/List;
    ...
    iget-object v1, p0, Lmdu;->j:Lmea;

    const/16 v2, 0xc

    invoke-static {p1, v2, v1, p2}, Lmcn;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    iget-object v1, p0, Lmdu;->k:Lmdy;

    const/16 v2, 0xd

    invoke-static {p1, v2, v1, p2}, Lmcn;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    iget-boolean v1, p0, Lmdu;->l:Z

    const/16 v2, 0xe

    invoke-static {p1, v2, v1}, Lmcn;->a(Landroid/os/Parcel;IZ)V

    iget-object v1, p0, Lmdu;->m:Landroid/graphics/Bitmap;

    const/16 v2, 0xf

    invoke-static {p1, v2, v1, p2}, Lmcn;->a(Landroid/os/Parcel;ILandroid/os/Parcelable;I)V

    iget-object p2, p0, Lmdu;->n:Ljava/lang/String;

    const/16 v1, 0x10

    invoke-static {p1, v1, p2, v3}, Lmcn;->a(Landroid/os/Parcel;ILjava/lang/String;Z)V

    iget-boolean p2, p0, Lmdu;->o:Z

    const/16 v1, 0x11

    invoke-static {p1, v1, p2}, Lmcn;->a(Landroid/os/Parcel;IZ)V

    iget-wide v1, p0, Lmdu;->p:J

    const/16 p0, 0x12

    invoke-static {p1, p0, v1, v2}, Lmcn;->a(Landroid/os/Parcel;IJ)V
...
.method public final bridge synthetic createFromParcel(Landroid/os/Parcel;)Ljava/lang/Object;
    ...
    :pswitch_6
    sget-object v3, Lmdy;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    :pswitch_7
    sget-object v3, Lmea;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    :pswitch_9
    sget-object v3, Lmdw;->CREATOR:Landroid/os/Parcelable$Creator;
    ...
    invoke-direct/range {v6 .. v23}, Lmdu;-><init>(Ljava/lang/String;Landroid/os/Bundle;Ljava/lang/String;Landroid/app/ApplicationErrorReport;Ljava/lang/String;Lcom/google/android/gms/common/data/BitmapTeleporter;Ljava/lang/String;Ljava/util/List;ZLmea;Lmdy;ZLandroid/graphics/Bitmap;Ljava/lang/String;ZJ)V
