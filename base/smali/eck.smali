...
# direct methods
.method public constructor <init>(Lcom/google/googlex/gcam/Tuning;Lnxu;)V
    .locals 4
    ...
    invoke-interface {p2, p1}, Lnxu;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p2, v0}, Lnxu;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p2, v1}, Lnxu;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    :goto_0
    invoke-direct {v1, p1, v0, v2, v3}, Lhbk;-><init>([Landroid/hardware/camera2/params/Face;Landroid/graphics/Rect;J)V

    iput-object v1, p0, Leck;->b:Lhbk;
