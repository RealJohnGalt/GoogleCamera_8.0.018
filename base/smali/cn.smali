...
# direct methods
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;Ldh;)V
    .locals 4
    ...
    invoke-virtual {p0}, Lcn;->getId()I

    move-result p2

    invoke-virtual {p3, p2}, Ldh;->b(I)Lcd;
    ...
    invoke-virtual {p2, p1, v1}, Lcp;->c(Ljava/lang/ClassLoader;Ljava/lang/String;)Lcd;

    move-result-object p1

    invoke-virtual {p1}, Lcd;->J()V

    invoke-virtual {p3}, Ldh;->a()Ldt;

    move-result-object p2

    iput-boolean v0, p2, Ldt;->r:Z

    iput-object p0, p1, Lcd;->N:Landroid/view/ViewGroup;

    invoke-virtual {p0}, Landroid/view/ViewGroup;->getId()I

    move-result p3

    invoke-virtual {p2, p3, p1, v2}, Ldt;->a(ILcd;Ljava/lang/String;)V

    invoke-virtual {p2}, Ldt;->d()V

    move-object p1, p2

    check-cast p1, Lbq;

    iget-object p1, p1, Lbq;->a:Ldh;

    invoke-virtual {p1, p2, v0}, Ldh;->b(Ldf;Z)V
...
.method public final addView(Landroid/view/View;ILandroid/view/ViewGroup$LayoutParams;)V
    ...
    invoke-static {p1}, Ldh;->a(Landroid/view/View;)Lcd;
...
.method protected final dispatchDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lcn;->getDrawingTime()J
...
.method public final onApplyWindowInsets(Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    :goto_0
    invoke-virtual {p0}, Lcn;->getChildCount()I

    move-result v1

    if-ge v0, v1, :cond_0

    invoke-virtual {p0, v0}, Lcn;->getChildAt(I)Landroid/view/View;
...
.method public final removeAllViewsInLayout()V
    ...
    invoke-direct {p0, v1}, Lcn;->a(Landroid/view/View;)V
...
.method protected final removeDetachedView(Landroid/view/View;Z)V
    ...
    invoke-direct {p0, p1}, Lcn;->a(Landroid/view/View;)V
...
.method public final removeViewAt(I)V
    ...
    invoke-virtual {p0, p1}, Lcn;->getChildAt(I)Landroid/view/View;

    move-result-object v0

    invoke-direct {p0, v0}, Lcn;->a(Landroid/view/View;)V
