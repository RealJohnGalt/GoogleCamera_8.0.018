...
.method public static constructor <clinit>()V
    ...
    sput-object v0, Luo;->a:[Ljava/lang/Class;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Luo;->b:Landroid/graphics/Rect;
    ...
    iput-object v0, p0, Luo;->k:Landroid/text/TextUtils$TruncateAt;

    sget-object v0, Landroid/text/Layout$Alignment;->ALIGN_CENTER:Landroid/text/Layout$Alignment;

    iput-object v0, p0, Luo;->l:Landroid/text/Layout$Alignment;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Luo;->m:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, p0, Luo;->n:Landroid/graphics/Rect;
...
.method public final a(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V
    ...
    iget-object v0, p0, Luo;->f:Ljava/lang/CharSequence;
    ...
    iget-object v0, p0, Luo;->b:Landroid/graphics/Rect;
    ...
    iget-object v5, p0, Luo;->c:Landroid/text/TextPaint;
    ...
    invoke-virtual {p0, v5}, Luo;->a(Landroid/text/TextPaint;)V
    ...
    iget-object v6, p0, Luo;->c:Landroid/text/TextPaint;
    ...
    iget-object v4, p0, Luo;->f:Ljava/lang/CharSequence;
    ...
    iget-object v4, p0, Luo;->k:Landroid/text/TextUtils$TruncateAt;
    ...
    iget-object v7, p0, Luo;->f:Ljava/lang/CharSequence;
    ...
    :goto_4
    iput-object v4, p0, Luo;->d:Ljava/lang/String;
    ...
    iget-object v4, p0, Luo;->l:Landroid/text/Layout$Alignment;
    ...
    iput-object v0, p0, Luo;->h:Landroid/text/StaticLayout;

    iput-boolean v3, p0, Luo;->p:Z

    iput-boolean v1, p0, Luo;->q:Z
    ...
    invoke-virtual {p0}, Luo;->a()Z

    move-result p2

    xor-int/lit8 v9, p2, 0x1

    iget-object p2, p0, Luo;->b:Landroid/graphics/Rect;
    ...
    :goto_7
    iget-object v4, p0, Luo;->b:Landroid/graphics/Rect;

    invoke-virtual {v4}, Landroid/graphics/Rect;->height()I

    move-result v4

    iget-object v5, p0, Luo;->b:Landroid/graphics/Rect;

    invoke-virtual {v5}, Landroid/graphics/Rect;->height()I

    move-result v5

    iget-object v6, p0, Luo;->m:Landroid/graphics/Rect;

    iget-object v7, p0, Luo;->b:Landroid/graphics/Rect;
    ...
    iget-object p2, p0, Luo;->h:Landroid/text/StaticLayout;
    ...
    iget-object v7, p0, Luo;->m:Landroid/graphics/Rect;

    iget-object v8, p0, Luo;->n:Landroid/graphics/Rect;

    invoke-static/range {v4 .. v9}, Landroid/view/Gravity;->apply(IIILandroid/graphics/Rect;Landroid/graphics/Rect;I)V

    iput-boolean v3, p0, Luo;->q:Z

    :cond_e
    invoke-virtual {p1}, Landroid/graphics/Canvas;->save()I

    iget-object p2, p0, Luo;->n:Landroid/graphics/Rect;

    iget p2, p2, Landroid/graphics/Rect;->left:I

    int-to-float p2, p2

    iget-object v0, p0, Luo;->n:Landroid/graphics/Rect;
...
.method public final a(Landroid/text/Layout$Alignment;)V
    ...
    iget-object v0, p0, Luo;->l:Landroid/text/Layout$Alignment;
    ...
    :cond_0
    iput-object p1, p0, Luo;->l:Landroid/text/Layout$Alignment;
...
.method public final a(Landroid/text/TextPaint;)V
    ...
    iput-object p1, p0, Luo;->c:Landroid/text/TextPaint;
...
.method public final a(Ljava/lang/CharSequence;)V
    ...
    iget-object v0, p0, Luo;->e:Ljava/lang/CharSequence;
    ...
    :cond_0
    iput-object p1, p0, Luo;->e:Ljava/lang/CharSequence;
    ...
    sget-object v5, Luo;->a:[Ljava/lang/Class;
    ...
    :cond_4
    iput-object p1, p0, Luo;->f:Ljava/lang/CharSequence;
...
.method public final a(Z)V
    ...
    :cond_0
    iput-boolean p1, p0, Luo;->o:Z

    iget-object p1, p0, Luo;->d:Ljava/lang/String;
...
.method public final a()Z
    ...
    iget-object v0, p0, Luo;->h:Landroid/text/StaticLayout;
