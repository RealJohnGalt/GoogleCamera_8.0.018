...
.field public final b:Lqzl;

.field public final c:Leau;

.field public final d:Lfjq;

.field public final e:Lgsk;
...
# direct methods
.method public constructor <init>(Lcom/google/googlex/gcam/Gcam;Lcwn;Lnsr;Lntc;Leau;Lfjq;Lgsk;Lhil;)V
    .locals 0

    invoke-direct {p0}, Ljava/lang/Object;-><init>()V

    iput-object p5, p0, Lgjx;->c:Leau;

    iput-object p6, p0, Lgjx;->d:Lfjq;

    iput-object p3, p0, Lgjx;->a:Lnsr;

    iput-object p7, p0, Lgjx;->e:Lgsk;

    new-instance p5, Lqzl;

    invoke-direct {p5, p3, p4}, Lqzl;-><init>(Lnsr;Lntc;)V

    iput-object p5, p0, Lgjx;->b:Lqzl;

    iput-object p8, p0, Lgjx;->f:Lhil;

    iput-object p1, p0, Lgjx;->g:Lcom/google/googlex/gcam/Gcam;

    iput-object p2, p0, Lgjx;->h:Lcwn;
...
# virtual methods
.method public final a(Lnxu;I)Lgot;
    .locals 10

    iget-object v0, p0, Lgjx;->c:Leau;

    invoke-interface {v0, p1}, Leau;->a(Lnxu;)I

    move-result v0

    iget-object v1, p0, Lgjx;->g:Lcom/google/googlex/gcam/Gcam;
    ...
    iget-object v1, p0, Lgjx;->c:Leau;

    const/4 v7, 0x0

    invoke-interface {v1, p1, v7}, Leau;->a(Lnxu;Lcom/google/googlex/gcam/GyroSampleVector;)Lcom/google/googlex/gcam/FrameMetadata;
    ...
    iget-object v1, p0, Lgjx;->b:Lqzl;

    invoke-virtual {v1, p1}, Lqzl;->e(Lnxu;)Lcom/google/googlex/gcam/SpatialGainMap;
    ...
    iget-object v1, p0, Lgjx;->d:Lfjq;

    invoke-interface {v1}, Lfjq;->d()Lpxt;
    ...
    iget-object v2, p0, Lgjx;->b:Lqzl;

    invoke-virtual {v1}, Ljava/lang/Integer;->intValue()I

    move-result v1

    invoke-virtual {v2, v1}, Lqzl;->a(I)F
    ...
    iget-object v2, p0, Lgjx;->a:Lnsr;

    invoke-static {p2, v2}, Lbhk;->a(ILnsr;)I
    ...
    iget-object p2, p0, Lgjx;->e:Lgsk;

    invoke-virtual {p2}, Lmwv;->a()Ljava/lang/Object;
    ...
    sget-object p2, Landroidx/preference/util/Field;->EOd:Ljava/lang/String;

    invoke-virtual {v8, p2}, Lcom/google/googlex/gcam/ExifMetadata;->b(Ljava/lang/String;)V

    new-instance p2, Lgot;
    ...
    iget-object v4, p0, Lgjx;->f:Lhil;

    iget-object v4, v4, Lhil;->b:Lncc;

    invoke-virtual {v1, v2, p1, v3, v4}, Lqzl;->a(Lcom/google/googlex/gcam/AeShotParams;Lnxu;FLncc;)V

    invoke-direct {p2, v8, v0, v2, v9}, Lgot;-><init>(Lcom/google/googlex/gcam/ExifMetadata;ILcom/google/googlex/gcam/AeShotParams;Lcom/google/googlex/gcam/SpatialGainMap;)V
