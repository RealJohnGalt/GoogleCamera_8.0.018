...
.field private static final h:Lgo;
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h:Lgo;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->j:Lyp;
    ...
    invoke-static/range {v2 .. v8}, Lhh;->a(Landroid/view/View;Landroid/content/Context;[ILandroid/util/AttributeSet;Landroid/content/res/TypedArray;II)V
    ...
    invoke-direct {p2, p0}, Lyj;-><init>(Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V
    ...
    invoke-static {p0, p1}, Lhh;->b(Landroid/view/View;I)V
...
.method private static a()Landroid/graphics/Rect;
    ...
    sget-object v0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->h:Lgo;
...
.method public static a(Landroid/content/Context;Landroid/util/AttributeSet;Ljava/lang/String;)Lyh;
    .locals 5
    ...
    sget-object v1, Lqze;->oEKynCYGVuuCw:Ljava/lang/String;
...
.method private static final a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Lyk;II)V
    .locals 6
...
.method private final a(Lyk;Landroid/graphics/Rect;II)V
    .locals 5
...
.method private final a(Landroid/view/MotionEvent;I)Z
    ...
    :cond_4
    invoke-direct {p0, v9, v7, v3, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->a(Lyh;Landroid/view/View;Landroid/view/MotionEvent;I)Z
    ...
    invoke-direct {p0, v9, v7, p1, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->a(Lyh;Landroid/view/View;Landroid/view/MotionEvent;I)Z
    ...
    :cond_7
    invoke-direct {p0, v10, v9, v3, p2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->a(Lyh;Landroid/view/View;Landroid/view/MotionEvent;I)Z
    ...
    :cond_9
    iget-object v7, v8, Lyk;->a:Lyh;

    if-nez v7, :cond_a

    iput-boolean v4, v8, Lyk;->m:Z
...
.method private final a(Lyh;Landroid/view/View;Landroid/view/MotionEvent;I)Z
    .locals 0

    if-eqz p4, :cond_0

    invoke-virtual {p1, p0, p2, p3}, Lyh;->b(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
    ...
    :cond_0
    invoke-virtual {p1, p0, p2, p3}, Lyh;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method private final b(I)I
    ...
    sget-object v3, Lkke;->uhQ:Ljava/lang/String;
...
.method static final b(Landroid/view/View;)Lyk;
    .locals 6
    ...
    :cond_0
    invoke-virtual {v0, p0}, Lyk;->a(Lyh;)V

    iput-boolean v3, v0, Lyk;->b:Z
    ...
    :try_start_0
    invoke-interface {v1}, Lyi;->a()Ljava/lang/Class;
    ...
    sget-object v5, Lifu;->pYfi:Ljava/lang/String;
...
.method private final b()V
    ...
    invoke-virtual {v0, p0, v2, v1}, Lyh;->b(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method private final c()V
    ...
    invoke-static {p0}, Lhh;->r(Landroid/view/View;)Z
    ...
    invoke-direct {v0, p0}, Lyf;-><init>(Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V
...
.method private static final c(Landroid/view/View;I)V
    ...
    invoke-static {p0, v1}, Lhh;->e(Landroid/view/View;I)V
...
.method private static final d(Landroid/view/View;I)V
    ...
    invoke-static {p0, v1}, Lhh;->d(Landroid/view/View;I)V
...
.method public final a(Landroid/view/View;)Ljava/util/List;
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->j:Lyp;

    iget-object v1, v0, Lyp;->b:Lxn;
    ...
    iget-object v4, v0, Lyp;->b:Lxn;

    invoke-virtual {v4, v3}, Lxn;->c(I)Ljava/lang/Object;
    ...
    invoke-virtual {v4, v3}, Lxn;->b(I)Ljava/lang/Object;
...
.method public final a(I)V
    ...
    iget-object v3, v7, Lyk;->l:Landroid/view/View;
    ...
    iget-object v2, v4, Lyk;->k:Landroid/view/View;
    ...
    iget-object v5, v4, Lyk;->k:Landroid/view/View;

    invoke-static {v0, v5, v3}, Lyq;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static/range {v2 .. v7}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Lyk;II)V
    ...
    invoke-direct {v0, v2, v13, v3, v9}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->a(Lyk;Landroid/graphics/Rect;II)V
    ...
    invoke-static {v15, v3}, Lhh;->e(Landroid/view/View;I)V

    :cond_4
    if-eqz v4, :cond_5

    invoke-static {v15, v4}, Lhh;->d(Landroid/view/View;I)V

    :cond_5
    if-eqz v5, :cond_6

    iget-object v3, v2, Lyk;->a:Lyh;

    if-eqz v3, :cond_6

    iget-object v2, v2, Lyk;->k:Landroid/view/View;

    invoke-virtual {v3, v0, v15, v2}, Lyh;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    invoke-static {v15}, Lhh;->z(Landroid/view/View;)Z
    ...
    invoke-virtual {v3, v15}, Lyh;->c(Landroid/view/View;)Z
    ...
    iget-object v4, v4, Lyk;->p:Landroid/graphics/Rect;
    ...
    iget-object v9, v7, Lyk;->a:Lyh;

    if-eqz v9, :cond_20

    invoke-virtual {v9, v15}, Lyh;->a(Landroid/view/View;)Z
    ...
    iget-boolean v12, v7, Lyk;->o:Z

    if-eqz v12, :cond_1d

    invoke-virtual {v7}, Lyk;->a()V
    ...
    invoke-virtual {v9, v0, v6, v15}, Lyh;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/View;)Z
    ...
    :cond_1e
    invoke-virtual {v9, v0, v15}, Lyh;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;)V
...
.method public final a(Landroid/view/View;I)V
    ...
    invoke-virtual {v0, p2}, Lha;->a(I)V
    ...
    invoke-virtual {v4, p2}, Lyk;->a(I)Z
    ...
    :cond_0
    iget-object v5, v4, Lyk;->a:Lyh;

    if-eqz v5, :cond_1

    invoke-virtual {v5, v3, p1, p2}, Lyh;->a(Landroid/view/View;Landroid/view/View;I)V

    :cond_1
    nop

    invoke-virtual {v4, p2, v1}, Lyk;->a(IZ)V

    invoke-virtual {v4}, Lyk;->a()V
...
.method public final a(Landroid/view/View;IIIII[I)V
    ...
    invoke-virtual {v1, v14}, Lyk;->a(I)Z
    ...
    invoke-virtual/range {v0 .. v6}, Lyh;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III[I)V
...
.method public final a(Landroid/view/View;II[II)V
    ...
    invoke-virtual {v8, v14}, Lyk;->a(I)Z
    ...
    invoke-virtual/range {v8 .. v13}, Lyh;->a(Landroid/view/View;Landroid/view/View;I[II)V
...
.method final a(Landroid/view/View;ZLandroid/graphics/Rect;)V
    ...
    invoke-static {p0, p1, p3}, Lyq;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public final a(Landroid/view/View;II)Z
    ...
    invoke-static {p0, p1, v0}, Lyq;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
...
.method public final a(Landroid/view/View;Landroid/view/View;II)Z
    ...
    iget-object v4, v3, Lyk;->a:Lyh;

    if-eqz v4, :cond_0

    invoke-virtual {v4, v2, p3, p4}, Lyh;->a(Landroid/view/View;II)Z

    move-result v2

    or-int/2addr v1, v2

    invoke-virtual {v3, p4, v2}, Lyk;->a(IZ)V
    ...
    invoke-virtual {v3, p4, p2}, Lyk;->a(IZ)V
...
.method public final b(Landroid/view/View;I)V
    ...
    iget-object v1, v0, Lyk;->k:Landroid/view/View;
    ...
    :try_start_0
    invoke-static {p0, v1, v6}, Lyq;->a(Landroid/view/ViewGroup;Landroid/view/View;Landroid/graphics/Rect;)V
    ...
    invoke-static/range {v0 .. v5}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->a(ILandroid/graphics/Rect;Landroid/graphics/Rect;Lyk;II)V

    invoke-direct {p0, v8, v7, v9, v10}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->a(Lyk;Landroid/graphics/Rect;II)V
    ...
    iget v5, v0, Lyk;->bottomMargin:I

    sub-int/2addr v4, v5

    invoke-virtual {v7, v1, v2, v3, v4}, Landroid/graphics/Rect;->set(IIII)V

    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e:Lhu;
    ...
    iget-object v2, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e:Lhu;

    invoke-virtual {v2}, Lhu;->a()I
...
.method public final b(Landroid/view/View;Landroid/view/View;II)V
    ...
    invoke-virtual {p1, p3, p4}, Lha;->a(II)V
    ...
    invoke-virtual {p3, p4}, Lyk;->a(I)Z
...
.method protected final bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-direct {v0, p1}, Lyk;-><init>(Lyk;)V
    ...
    invoke-direct {v0, p1}, Lyk;-><init>(Landroid/view/ViewGroup$MarginLayoutParams;)V
    ...
    invoke-direct {v0, p1}, Lyk;-><init>(Landroid/view/ViewGroup$LayoutParams;)V
...
.method public final onAttachedToWindow()V
    ...
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Lyl;

    if-nez v0, :cond_0

    new-instance v0, Lyl;

    invoke-direct {v0, p0}, Lyl;-><init>(Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    iput-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Lyl;
    ...
    iget-object v1, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Lyl;

    invoke-virtual {v0, v1}, Landroid/view/ViewTreeObserver;->addOnPreDrawListener(Landroid/view/ViewTreeObserver$OnPreDrawListener;)V

    :cond_1
    iget-object v0, p0, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e:Lhu;
    ...
    invoke-static {p0}, Lhh;->q(Landroid/view/View;)V
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p5, p5, Lyk;->a:Lyh;

    if-eqz p5, :cond_1

    invoke-virtual {p5, p0, p4, p1}, Lyh;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;I)Z
...
.method protected final onMeasure(II)V
    ...
    iget-object v0, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->j:Lyp;
    ...
    iget-object v3, v0, Lyp;->b:Lxn;

    invoke-virtual {v3, v2}, Lxn;->c(I)Ljava/lang/Object;
    ...
    invoke-static {v2}, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->b(Landroid/view/View;)Lyk;
    ...
    iput-object v8, v3, Lyk;->l:Landroid/view/View;

    iput-object v8, v3, Lyk;->k:Landroid/view/View;

    goto/16 :goto_6

    :cond_2
    iget-object v4, v3, Lyk;->k:Landroid/view/View;
    ...
    :cond_7
    iput-object v4, v3, Lyk;->l:Landroid/view/View;
    ...
    iput-object v4, v3, Lyk;->k:Landroid/view/View;
    ...
    :goto_6
    iget-object v4, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->j:Lyp;

    invoke-virtual {v4, v2}, Lyp;->a(Ljava/lang/Object;)V
    ...
    iget-object v8, v3, Lyk;->l:Landroid/view/View;
    ...
    :cond_11
    iget-object v8, v3, Lyk;->a:Lyh;

    if-eqz v8, :cond_16

    invoke-virtual {v8, v5}, Lyh;->a(Landroid/view/View;)Z
    ...
    :cond_12
    :goto_8
    iget-object v8, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->j:Lyp;

    iget-object v8, v8, Lyp;->b:Lxn;

    invoke-virtual {v8, v5}, Lxn;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v8, v5}, Lyp;->a(Ljava/lang/Object;)V

    :cond_13
    iget-object v8, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->j:Lyp;

    iget-object v9, v8, Lyp;->b:Lxn;

    invoke-virtual {v9, v5}, Lxn;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v9, v2}, Lxn;->containsKey(Ljava/lang/Object;)Z
    ...
    invoke-virtual {v9, v5}, Lxn;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-virtual {v8, v5, v9}, Lxn;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    iget-object v1, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->j:Lyp;

    iget-object v2, v1, Lyp;->c:Ljava/util/ArrayList;

    invoke-virtual {v2}, Ljava/util/ArrayList;->clear()V

    iget-object v2, v1, Lyp;->d:Ljava/util/HashSet;

    invoke-virtual {v2}, Ljava/util/HashSet;->clear()V

    iget-object v2, v1, Lyp;->b:Lxn;
    ...
    iget-object v4, v1, Lyp;->b:Lxn;

    invoke-virtual {v4, v3}, Lxn;->b(I)Ljava/lang/Object;

    move-result-object v4

    iget-object v5, v1, Lyp;->c:Ljava/util/ArrayList;

    iget-object v8, v1, Lyp;->d:Ljava/util/HashSet;

    invoke-virtual {v1, v4, v5, v8}, Lyp;->a(Ljava/lang/Object;Ljava/util/ArrayList;Ljava/util/HashSet;)V
    ...
    :cond_1b
    iget-object v1, v1, Lyp;->c:Ljava/util/ArrayList;
    ...
    iget-object v3, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->j:Lyp;

    iget-object v4, v3, Lyp;->b:Lxn;
    ...
    iget-object v9, v3, Lyp;->b:Lxn;

    invoke-virtual {v9, v5}, Lxn;->c(I)Ljava/lang/Object;
    ...
    iget-object v0, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Lyl;

    if-nez v0, :cond_1f

    new-instance v0, Lyl;

    invoke-direct {v0, v6}, Lyl;-><init>(Landroidx/coordinatorlayout/widget/CoordinatorLayout;)V

    iput-object v0, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Lyl;
    ...
    iget-object v1, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->t:Lyl;
    ...
    iget-object v2, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e:Lhu;

    if-eqz v2, :cond_25

    invoke-static/range {p0 .. p0}, Lhh;->r(Landroid/view/View;)Z
    ...
    invoke-static {v0}, Lhh;->r(Landroid/view/View;)Z

    move-result v1

    if-nez v1, :cond_2f

    iget-object v1, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e:Lhu;

    invoke-virtual {v1}, Lhu;->a()I
    ...
    iget-object v0, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e:Lhu;
    ...
    iget-object v3, v6, Landroidx/coordinatorlayout/widget/CoordinatorLayout;->e:Lhu;
    ...
    invoke-virtual/range {v0 .. v5}, Lyh;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;III)Z
    ...
    iget v2, v7, Lyk;->leftMargin:I

    add-int/2addr v1, v2

    iget v2, v7, Lyk;->rightMargin:I
    ...
    iget v3, v7, Lyk;->topMargin:I

    add-int/2addr v2, v3

    iget v3, v7, Lyk;->bottomMargin:I
...
.method public final onNestedPreFling(Landroid/view/View;FF)Z
    ...
    iget-boolean v3, v2, Lyk;->n:Z

    if-eqz v3, :cond_1

    iget-object v2, v2, Lyk;->a:Lyh;

    if-eqz v2, :cond_1

    invoke-virtual {v2, p1}, Lyh;->b(Landroid/view/View;)Z
...
.method protected final onRestoreInstanceState(Landroid/os/Parcelable;)V
    ...
    iget-object p1, p1, Lyn;->a:Landroid/util/SparseArray;
    ...
    invoke-virtual {v4, v2, v3}, Lyh;->a(Landroid/view/View;Landroid/os/Parcelable;)V
...
.method protected final onSaveInstanceState()Landroid/os/Parcelable;
    ...
    invoke-direct {v0, v1}, Lyn;-><init>(Landroid/os/Parcelable;)V
    ...
    invoke-virtual {v6, v4}, Lyh;->d(Landroid/view/View;)Landroid/os/Parcelable;
    ...
    :cond_1
    iput-object v1, v0, Lyn;->a:Landroid/util/SparseArray;
...
.method public final onTouchEvent(Landroid/view/MotionEvent;)Z
    ...
    invoke-virtual {v1, p0, v4, p1}, Lyh;->b(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
...
.method public final requestChildRectangleOnScreen(Landroid/view/View;Landroid/graphics/Rect;Z)Z
    ...
    invoke-virtual {v0, p0, p1, p2}, Lyh;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/graphics/Rect;)Z
...
.method public final requestDisallowInterceptTouchEvent(Z)V
    ...
    :cond_0
    invoke-virtual {v3, p0, v2, v0}, Lyh;->a(Landroidx/coordinatorlayout/widget/CoordinatorLayout;Landroid/view/View;Landroid/view/MotionEvent;)Z
