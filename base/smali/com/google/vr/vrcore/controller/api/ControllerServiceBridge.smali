...
.method public constructor <init>(Landroid/content/Context;Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;I)V
    ...
    invoke-direct {v0, p3}, Lrkl;-><init>(I)V
    ...
    invoke-direct {v1, p2, v0, v2}, Lrkx;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lrkl;I)V

    iput-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lrkx;
    ...
    invoke-direct {p2, p0}, Lrle;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;)V

    iput-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->k:Lrle;
    ...
    move-result v2
    :try_end_0
    .catch Lrjt; {:try_start_0 .. :try_end_0} :catch_0
...
.method private final a(ILrkx;)Z
    .locals 3

    :try_start_0
    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrld;

    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->c:Ljava/lang/String;

    new-instance v2, Lrlc;

    invoke-direct {v2, p2}, Lrlc;-><init>(Lrkx;)V
    ...
    invoke-static {p2, v2}, Lbbn;->a(Landroid/os/Parcel;Landroid/os/IInterface;)V

    const/4 p1, 0x5

    invoke-virtual {v0, p1, p2}, Lbbl;->a(ILandroid/os/Parcel;)Landroid/os/Parcel;
...
.method public final a()V
    ...
    iget-object v2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->k:Lrle;
    ...
    iput-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrld;
...
.method public final a(ILrkr;)V
    ...
    invoke-static {v2, p2}, Lbbn;->a(Landroid/os/Parcel;Landroid/os/Parcelable;)V

    const/16 p1, 0xb

    invoke-virtual {v0, p1, v2}, Lbbl;->b(ILandroid/os/Parcel;)V
    :try_end_0
    .catch Landroid/os/RemoteException; {:try_start_0 .. :try_end_0} :catch_0
...
.method public final b()V
    ...
    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lrkx;
    ...
    invoke-direct {p0, v1, v0}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->a(ILrkx;)Z
    ...
    iget-object v1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lrkx;
...
.method public controllerHapticsEffect(III)V
    ...
    new-instance p3, Lrkr;

    invoke-direct {p3}, Lrkr;-><init>()V

    invoke-virtual {p3, p2}, Lrjr;->a(Lrdo;)V

    iget-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->b:Landroid/os/Handler;

    new-instance v0, Lrkv;

    invoke-direct {v0, p0, p1, p3}, Lrkv;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;ILrkr;)V
...
.method public createAndConnectController(ILcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;I)Z
    ...
    iget-object p3, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrld;
    ...
    :cond_0
    new-instance p3, Lrkx;

    invoke-direct {p3, p2, v0, p1}, Lrkx;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;Lrkl;I)V

    iget p2, p3, Lrkx;->c:I

    invoke-direct {p0, p2, p3}, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->a(ILrkx;)Z
    ...
    iput-object p3, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lrkx;
...
.method public final onServiceConnected(Landroid/content/ComponentName;Landroid/os/IBinder;)V
    ...
    invoke-direct {v0, p2}, Lrld;-><init>(Landroid/os/IBinder;)V

    move-object p2, v0

    :goto_0
    iput-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrld;

    :try_start_0
    invoke-virtual {p2}, Lbbl;->v()Landroid/os/Parcel;
    ...
    invoke-virtual {p2, v1, v0}, Lbbl;->a(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    iget-object p1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lrkx;

    iget-object p1, p1, Lrkx;->a:Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge$Callbacks;
    ...
    :try_start_1
    iget-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrld;

    iget-object v0, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->k:Lrle;
    ...
    invoke-virtual {p2, v0, v1}, Lbbl;->a(ILandroid/os/Parcel;)Landroid/os/Parcel;
    ...
    iget-object p2, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->e:Lrkx;
...
.method public final onServiceDisconnected(Landroid/content/ComponentName;)V
    ...
    iput-object p1, p0, Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;->g:Lrld;
...
.method public requestBind()V
    ...
    invoke-direct {v1, p0}, Lrks;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;)V
...
.method public requestUnbind()V
    ...
    invoke-direct {v1, p0}, Lrkt;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;)V
...
.method public vibrateController(IIII)V
    ...
    new-instance p4, Lrku;

    invoke-direct {p4, p0, p1, p3}, Lrku;-><init>(Lcom/google/vr/vrcore/controller/api/ControllerServiceBridge;ILrkr;)V
