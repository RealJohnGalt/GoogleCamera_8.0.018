...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    sget-object v0, Lkms;->a:Landroid/preference/Preference$OnPreferenceChangeListener;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    sget-object p2, Lkmt;->a:Landroid/preference/Preference$OnPreferenceChangeListener;
...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    sget-object p2, Lkmu;->a:Landroid/preference/Preference$OnPreferenceChangeListener;
...
.method public static final a(Landroid/widget/FrameLayout;)I
    .locals 0
...
.method private final a(Landroid/content/Context;)V
    ...
    invoke-interface {p1, v0}, Lepc;->a(Ljava/lang/Class;)Lepe;

    move-result-object p1

    check-cast p1, Lkmy;

    invoke-interface {p1, p0}, Lkmy;->a(Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;)V
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->b:Lisf;

    invoke-interface {v0, p1}, Lisf;->a(Lirs;)Ljava/lang/Object;
    ...
    :cond_0
    iget-object p1, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->a:Lisa;

    invoke-virtual {p0}, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->getKey()Ljava/lang/String;

    move-result-object v0

    invoke-virtual {p1, v0}, Lisa;->a(Ljava/lang/String;)Z
...
.method public final a(Ljava/lang/String;Ljava/lang/Runnable;)V
    ...
    iput-object p1, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->p:Ljava/lang/String;
...
.method protected final onBindView(Landroid/view/View;)V
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->q:Landroid/widget/Switch;
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->q:Landroid/widget/Switch;
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->o:Landroid/widget/LinearLayout;
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->r:Landroid/widget/TextView;
    ...
    :cond_4
    iget-object v0, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->p:Ljava/lang/String;
    ...
    iput-object v0, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->n:Landroid/widget/Button;

    if-eqz v0, :cond_5

    iget-object v1, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->p:Ljava/lang/String;

    invoke-virtual {v0, v1}, Landroid/widget/Button;->setText(Ljava/lang/CharSequence;)V

    iget-object v0, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->n:Landroid/widget/Button;

    new-instance v1, Lkmv;

    invoke-direct {v1, p0}, Lkmv;-><init>(Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;)V
    ...
    iget-object v3, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->j:Ljava/lang/String;

    invoke-virtual {v0, v3}, Landroid/widget/Button;->setText(Ljava/lang/CharSequence;)V

    new-instance v3, Lkmw;

    invoke-direct {v3, p1, v1}, Lkmw;-><init>(Landroid/widget/FrameLayout;Landroid/widget/ImageView;)V
    ...
    invoke-direct {v1, v0}, Lkmx;-><init>(Landroid/widget/Button;)V
...
.method public final onPreferenceChange(Landroid/preference/Preference;Ljava/lang/Object;)Z
    ...
    iget-object v0, p0, Lcom/google/android/apps/camera/ui/preference/ManagedSwitchPreference;->a:Lisa;
