...
.field private volatile m:Llxf;

.field private mResultGuardian:Llxx;
...
.method constructor <init>()V
    ...
    invoke-direct {v0, v1}, Llxw;-><init>(Landroid/os/Looper;)V

    iput-object v0, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Llxw;
...
.method protected constructor <init>(Llwv;)V
    .locals 2
    ...
    iget-object v0, v0, Llyo;->a:Llws;

    iget-object v0, v0, Llws;->f:Landroid/os/Looper;

    new-instance v1, Llxw;

    invoke-direct {v1, v0}, Llxw;-><init>(Landroid/os/Looper;)V

    iput-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Llxw;
...
.method private final b()Llxb;
    ...
    invoke-static {v1, v3}, Lmcj;->a(ZLjava/lang/Object;)V
    ...
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Llxb;

    const/4 v3, 0x0

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Llxb;

    iput-object v3, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Llxc;
...
.method public static b(Llxb;)V
    .locals 3

    instance-of v0, p0, Llwy;
...
# virtual methods
.method protected abstract a(Lcom/google/android/gms/common/api/Status;)Llxb;
.end method

.method public final a(Ljava/util/concurrent/TimeUnit;)Llxb;
    .locals 3
    ...
    invoke-static {v1, v0}, Lmcj;->a(ZLjava/lang/Object;)V
    ...
    invoke-static {p1, v0}, Lmcj;->a(ZLjava/lang/Object;)V

    invoke-direct {p0}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b()Llxb;
...
.method public final a(Llww;)V
    ...
    invoke-interface {p1, v1}, Llww;->a(Lcom/google/android/gms/common/api/Status;)V
...
.method public final a(Llxb;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Llxb;

    invoke-interface {p1}, Llxb;->a()Lcom/google/android/gms/common/api/Status;
    ...
    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Llxc;

    if-nez p1, :cond_0

    iget-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->c:Llxb;

    instance-of p1, p1, Llwy;

    if-eqz p1, :cond_1

    new-instance p1, Llxx;

    invoke-direct {p1, p0}, Llxx;-><init>(Lcom/google/android/gms/common/api/internal/BasePendingResult;)V

    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->mResultGuardian:Llxx;

    goto :goto_0

    :cond_0
    iget-object v1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b:Llxw;

    const/4 v2, 0x2

    invoke-virtual {v1, v2}, Llxw;->removeMessages(I)V
    ...
    invoke-virtual {v1, p1, v2}, Llxw;->a(Llxc;Llxb;)V
    ...
    invoke-interface {v3, v4}, Llww;->a(Lcom/google/android/gms/common/api/Status;)V
    ...
    :cond_3
    invoke-static {p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->b(Llxb;)V
...
.method public final a(Llxc;)V
    ...
    invoke-static {v2, v1}, Lmcj;->a(ZLjava/lang/Object;)V
    ...
    :cond_0
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/BasePendingResult;->h:Llxc;
...
.method public final c(Lcom/google/android/gms/common/api/Status;)V
    ...
    invoke-virtual {p0, p1}, Lcom/google/android/gms/common/api/internal/BasePendingResult;->a(Lcom/google/android/gms/common/api/Status;)Llxb;
