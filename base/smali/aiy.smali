...
# direct methods
.method public constructor <init>(Lajg;Lakn;Landroid/os/Looper;)V
    .locals 0

    iput-object p1, p0, Laiy;->a:Lajg;

    invoke-direct {p0, p3}, Lalh;-><init>(Landroid/os/Looper;)V
...
.method public final handleMessage(Landroid/os/Message;)V
    ...
    invoke-static {v3}, Lduj;->a(I)Ljava/lang/String;
    ...
    invoke-static {v1, v4}, Lall;->a(Lalk;Ljava/lang/String;)V

    goto/16 :goto_6

    :pswitch_0
    iget-object v1, p0, Laiy;->e:Laiz;

    invoke-virtual {v1}, Laiz;->b()Landroid/hardware/Camera$Parameters;
    ...
    iget-object v4, p0, Laiy;->c:Landroid/hardware/Camera;

    invoke-virtual {v4, v1}, Landroid/hardware/Camera;->setParameters(Landroid/hardware/Camera$Parameters;)V

    iget-object v1, p0, Laiy;->e:Laiz;

    invoke-virtual {v1}, Laiz;->a()V

    goto/16 :goto_6

    :pswitch_1
    iget-object v1, p0, Laiy;->c:Landroid/hardware/Camera;

    iget-object v4, p0, Laiy;->a:Lajg;

    iget-object v4, v4, Lajg;->b:Lakv;

    iget v6, p1, Landroid/os/Message;->arg1:I

    invoke-virtual {v4, v6, v3}, Lakv;->a(IZ)I
    ...
    invoke-virtual {v4, v5}, Lakv;->a(I)I
    ...
    :try_start_2
    sget-object v4, Lajg;->a:Lalk;

    invoke-virtual {v1}, Ljava/lang/RuntimeException;->getMessage()Ljava/lang/String;

    move-result-object v1

    invoke-static {v4, v1}, Lall;->b(Lalk;Ljava/lang/String;)V
    ...
    iget-object v4, v4, Lajg;->e:Lale;

    invoke-virtual {v4, v1}, Lale;->a(I)V
    ...
    invoke-static {v1}, Lall;->c(Lalk;)V

    goto/16 :goto_6

    :cond_2
    iget-object v1, p0, Laiy;->a:Lajg;

    iget-object v1, v1, Lajg;->e:Lale;

    const/16 v4, 0x10

    invoke-virtual {v1, v4}, Lale;->a(I)V
    ...
    iget-object v6, p0, Laiy;->a:Lajg;

    iget-object v6, v6, Lajg;->c:Lajj;

    invoke-virtual {v5}, Lald;->d()Lalj;

    move-result-object v6

    invoke-virtual {v6}, Lalj;->a()I
    ...
    iget-byte v4, v5, Lald;->n:B

    invoke-virtual {v1, v4}, Landroid/hardware/Camera$Parameters;->setJpegQuality(I)V

    iget-object v4, p0, Laiy;->a:Lajg;

    iget-object v4, v4, Lajg;->c:Lajj;

    sget-object v6, Lakp;->a:Lakp;

    invoke-virtual {v4, v6}, Laku;->a(Lakp;)Z
    ...
    iget-boolean v4, v5, Lald;->w:Z

    invoke-virtual {v1, v4}, Landroid/hardware/Camera$Parameters;->setAutoExposureLock(Z)V

    :cond_6
    iget-object v4, v5, Lald;->s:Lakr;

    invoke-virtual {v4}, Lakr;->name()Ljava/lang/String;

    move-result-object v4

    invoke-static {v4}, Lduj;->a(Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-virtual {v5}, Lald;->f()Ljava/util/List;
    ...
    invoke-virtual {v5}, Lald;->e()Ljava/util/List;
    ...
    invoke-virtual {v4}, Lakq;->name()Ljava/lang/String;
    ...
    invoke-virtual {v4}, Laks;->name()Ljava/lang/String;
    ...
    invoke-direct {v6, v4}, Lalj;-><init>(Lalj;)V
    ...
    iget-object v4, p0, Laiy;->e:Laiz;

    invoke-virtual {v4}, Laiz;->b()Landroid/hardware/Camera$Parameters;
    ...
    invoke-static {v4, v5, v1}, Lall;->a(Lalk;Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    iget-object v5, v1, Laix;->a:Landroid/hardware/Camera$ShutterCallback;

    iget-object v6, v1, Laix;->b:Landroid/hardware/Camera$PictureCallback;

    iget-object v7, v1, Laix;->c:Landroid/hardware/Camera$PictureCallback;

    iget-object v1, v1, Laix;->d:Landroid/hardware/Camera$PictureCallback;
    ...
    invoke-virtual {v1, v5}, Lale;->a(I)V
    ...
    :try_start_7
    iget-object v5, p0, Laiy;->c:Landroid/hardware/Camera;
    ...
    :try_start_8
    iget-object v5, p0, Laiy;->a:Lajg;

    iget-object v5, v5, Lajg;->e:Lale;

    invoke-virtual {v5, v1}, Lale;->a(I)V

    if-eqz v4, :cond_19

    new-instance v1, Laiw;

    iget-object v7, p0, Laiy;->a:Lajg;

    iget-object v9, p0, Laiy;->c:Landroid/hardware/Camera;

    iget-object v5, v7, Lajg;->b:Lakv;

    iget-object v10, v7, Lajg;->c:Lajj;

    move-object v5, v1

    move-object v6, v7

    invoke-direct/range {v5 .. v10}, Laiw;-><init>(Lajg;Lakn;ILandroid/hardware/Camera;Lajj;)V

    invoke-virtual {v4, v1}, Lajw;->a(Lakh;)V
    ...
    iget-object v5, v4, Lajw;->a:Landroid/os/Handler;

    new-instance v6, Lajv;

    invoke-direct {v6, v4, v1}, Lajv;-><init>(Lajw;Ljava/lang/String;)V
    ...
    invoke-virtual {v1, v3}, Lale;->a(I)V

    iput-object v2, p0, Laiy;->c:Landroid/hardware/Camera;
    ...
    invoke-static {v1, v4}, Lall;->b(Lalk;Ljava/lang/String;)V
    ...
    invoke-virtual {p0, v8}, Lalh;->b(I)Ljava/lang/String;

    move-result-object v1

    invoke-interface {v4, v8, v1}, Lajq;->b(ILjava/lang/String;)V

    goto :goto_6

    :cond_17
    sget-object v5, Lajg;->a:Lalk;
    ...
    iput-object v5, p0, Laiy;->c:Landroid/hardware/Camera;
    ...
    invoke-direct {v6, v5}, Laiz;-><init>(Landroid/hardware/Camera;)V

    iput-object v6, p0, Laiy;->e:Laiz;
    ...
    invoke-virtual {v6, v8}, Laim;->a(I)Lakv;

    move-result-object v6

    iput-object v6, v5, Lajg;->b:Lakv;

    iget-object v5, p0, Laiy;->a:Lajg;

    new-instance v6, Lajj;

    iget-object v7, p0, Laiy;->e:Laiz;

    invoke-virtual {v7}, Laiz;->b()Landroid/hardware/Camera$Parameters;

    move-result-object v7

    invoke-direct {v6, v7}, Lajj;-><init>(Landroid/hardware/Camera$Parameters;)V

    iput-object v6, v5, Lajg;->c:Lajj;
    ...
    iget-object v7, p0, Laiy;->b:Lakn;

    iget-object v9, p0, Laiy;->c:Landroid/hardware/Camera;

    iget-object v5, v6, Lajg;->b:Lakv;

    iget-object v10, v6, Lajg;->c:Lajj;

    move-object v5, v1

    invoke-direct/range {v5 .. v10}, Laiw;-><init>(Lajg;Lakn;ILandroid/hardware/Camera;Lajj;)V

    invoke-interface {v4, v1}, Lajq;->a(Lakh;)V
    ...
    invoke-interface {v4, v8, v1}, Lajq;->a(ILjava/lang/String;)V
    :try_end_8
    ...
    invoke-static {v0}, Lduj;->a(I)Ljava/lang/String;
    ...
    invoke-static {v6, v5, v1}, Lall;->a(Lalk;Ljava/lang/String;Ljava/lang/Throwable;)V

    iget-object v5, p0, Laiy;->a:Lajg;

    iget-object v5, v5, Lajg;->e:Lale;

    invoke-virtual {v5}, Lale;->b()V
    ...
    invoke-static {v6, v7, v5}, Lall;->a(Lalk;Ljava/lang/String;Ljava/lang/Throwable;)V
    :try_end_c
    ...
    iget-object v2, p0, Laiy;->c:Landroid/hardware/Camera;
    ...
    invoke-virtual {p0, v0}, Lalh;->b(I)Ljava/lang/String;

    move-result-object v0

    invoke-interface {v1, v2, v0}, Lajq;->a(ILjava/lang/String;)V

    goto/16 :goto_6

    :cond_1b
    iget-object v2, p0, Laiy;->b:Lakn;
    ...
    invoke-virtual {p0, v3}, Lalh;->b(I)Ljava/lang/String;

    move-result-object v3

    invoke-virtual {v2, v1, v3, v0, v4}, Lalc;->a(Ljava/lang/RuntimeException;Ljava/lang/String;II)V
    :try_end_d
    ...
    invoke-static {p1}, Lduj;->a(I)Ljava/lang/String;
...
.method public final onError(ILandroid/hardware/Camera;)V
    ...
    iget-object p2, p0, Laiy;->a:Lajg;

    sget-object v0, Lajg;->a:Lalk;

    iget-object p2, p2, Lajg;->g:Lalc;

    invoke-virtual {p2, p1}, Lalc;->a(I)V

    const/16 p2, 0x64

    if-ne p1, p2, :cond_0

    iget-object p1, p0, Lalh;->r:Ljava/util/LinkedList;
    ...
    iget-object v2, p0, Laiy;->a:Lajg;

    iget-object v2, v2, Lajg;->e:Lale;

    invoke-virtual {v2}, Lale;->a()I

    move-result v2

    invoke-virtual {p2, v0, v1, p1, v2}, Lalc;->a(Ljava/lang/RuntimeException;Ljava/lang/String;II)V
