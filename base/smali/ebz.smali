...
.method public constructor <init>(Lcwn;Ldzf;Lrof;Lcxo;)V
    .locals 7
    ...
    sget-object v0, Lcww;->i:Lcwq;

    const/4 v1, 0x0

    invoke-static {p1, v0, v1}, Lebz;->a(Lcwn;Lcwq;Ljava/lang/Integer;)Lcom/google/googlex/gcam/ThreadPoolConfig;
    ...
    :goto_1
    iget-wide v2, v6, Lcom/google/googlex/gcam/InitParams;->a:J

    invoke-static {v2, v3, v6, p1}, Lcom/google/googlex/gcam/GcamModuleJNI;->InitParams_allow_unknown_devices_set(JLcom/google/googlex/gcam/InitParams;Z)V

    iget p1, p2, Ldzf;->b:I

    iget-wide v2, v6, Lcom/google/googlex/gcam/InitParams;->a:J

    invoke-static {v2, v3, v6, p1}, Lcom/google/googlex/gcam/GcamModuleJNI;->InitParams_max_payload_frames_set(JLcom/google/googlex/gcam/InitParams;I)V

    invoke-virtual {v6, v1}, Lcom/google/googlex/gcam/InitParams;->a(I)V

    invoke-virtual {v6, v1}, Lcom/google/googlex/gcam/InitParams;->b(I)V

    invoke-virtual {p2}, Ldzf;->b()Z

    move-result p1

    if-eqz p1, :cond_2

    sget-object p1, Lebz;->b:Ljava/lang/String;

    invoke-static {p1}, Lkxm;->d(Ljava/lang/String;)V

    invoke-virtual {v6, v0}, Lcom/google/googlex/gcam/InitParams;->a(I)V

    :cond_2
    iget-object p1, p2, Ldzf;->a:Lcwn;

    sget-object p2, Lcww;->N:Lcwo;
    ...
    invoke-virtual {v6, v0}, Lcom/google/googlex/gcam/InitParams;->b(I)V

    :cond_3
    invoke-virtual {v6}, Lcom/google/googlex/gcam/InitParams;->b()I
    ...
    iput-object v6, p0, Lebz;->a:Lcom/google/googlex/gcam/InitParams;

    return-void
.end method

.method public static a(Lcwn;Lcwq;Ljava/lang/Integer;)Lcom/google/googlex/gcam/ThreadPoolConfig;
    .locals 8

    invoke-interface {p0, p1}, Lcwn;->a(Lcwq;)Lpxt;
