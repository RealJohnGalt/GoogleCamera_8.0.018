...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    invoke-direct {p0, p1, p2, p3}, Lmv;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V

    sget-object v0, Lko;->d:[I

    const/4 v1, 0x0

    invoke-static {p1, p2, v0, p3, v1}, Lsz;->a(Landroid/content/Context;Landroid/util/AttributeSet;[III)Lsz;

    move-result-object p1

    invoke-virtual {p1, v1}, Lsz;->a(I)Landroid/graphics/drawable/Drawable;
    ...
    invoke-virtual {p1, p2, v1}, Lsz;->f(II)I
    ...
    invoke-virtual {p1, p2, v1}, Lsz;->e(II)I
    ...
    invoke-virtual {p1, p2, p3}, Lsz;->f(II)I
...
.method public final a()V
    ...
    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lnj;
...
.method public final a(Lkv;)V
    ...
    invoke-direct {v2, p1}, Lmx;-><init>(Lkv;)V

    invoke-virtual {v0, v2}, Landroid/view/View;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    invoke-virtual {p1}, Lkv;->b()Landroid/view/Menu;

    move-result-object p1

    check-cast p1, Llw;

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lnj;
    ...
    invoke-direct {v0, v2}, Lnj;-><init>(Landroid/content/Context;)V

    iput-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lnj;

    iget-object v0, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lnj;

    invoke-virtual {v0}, Lnj;->h()V
    ...
    iget-object v2, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lnj;

    iget-object v3, p0, Landroid/support/v7/widget/ActionBarContextView;->b:Landroid/content/Context;

    invoke-virtual {p1, v2, v3}, Llw;->a(Lmk;Landroid/content/Context;)V

    iget-object p1, p0, Landroid/support/v7/widget/ActionBarContextView;->d:Lnj;

    iget-object v2, p1, Lnj;->f:Lmm;

    iget-object v3, p1, Llj;->f:Lmm;

    if-nez v3, :cond_3

    iget-object v3, p1, Llj;->d:Landroid/view/LayoutInflater;
    ...
    iput-object v1, p1, Llj;->f:Lmm;

    iget-object v1, p1, Llj;->f:Lmm;

    iget-object v3, p1, Llj;->c:Llw;

    invoke-interface {v1, v3}, Lmm;->a(Llw;)V
    ...
    invoke-virtual {v2, p1}, Landroid/support/v7/widget/ActionMenuView;->a(Lnj;)V
    ...
    invoke-static {p1, v1}, Lhh;->a(Landroid/view/View;Landroid/graphics/drawable/Drawable;)V
...
.method public final onDetachedFromWindow()V
    ...
    invoke-super {p0}, Lmv;->onDetachedFromWindow()V
...
.method public final onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
    ...
    :cond_0
    invoke-super {p0, p1}, Lmv;->onInitializeAccessibilityEvent(Landroid/view/accessibility/AccessibilityEvent;)V
