...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V
    ...
    invoke-direct {v2, v1}, Lvb;-><init>(Landroid/content/Context;)V

    iput-object v2, v0, Landroid/support/wearable/view/ActionPage;->b:Lvb;

    new-instance v2, Luw;

    invoke-direct {v2, v1}, Luw;-><init>(Landroid/content/Context;)V

    iput-object v2, v0, Landroid/support/wearable/view/ActionPage;->a:Luw;

    const/16 v3, 0x11

    invoke-virtual {v2, v3}, Luw;->b(I)V

    const/4 v4, 0x2

    invoke-virtual {v2, v4}, Luw;->a(I)V

    sget-object v2, Ltr;->b:[I
    ...
    iget-object v15, v0, Landroid/support/wearable/view/ActionPage;->b:Lvb;

    invoke-virtual {v2, v6}, Landroid/content/res/TypedArray;->getColorStateList(I)Landroid/content/res/ColorStateList;

    move-result-object v6

    iput-object v6, v15, Lvb;->b:Landroid/content/res/ColorStateList;

    iget-object v6, v15, Lvb;->a:Landroid/graphics/drawable/ShapeDrawable;

    invoke-virtual {v6}, Landroid/graphics/drawable/ShapeDrawable;->getPaint()Landroid/graphics/Paint;

    move-result-object v6

    iget-object v15, v15, Lvb;->b:Landroid/content/res/ColorStateList;
    ...
    iget-object v4, v15, Lvb;->c:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v6, v15, Lvb;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v15}, Lvb;->requestLayout()V

    invoke-virtual {v15}, Lvb;->invalidate()V
    ...
    iget-object v6, v0, Landroid/support/wearable/view/ActionPage;->b:Lvb;
    ...
    iget-object v4, v6, Lvb;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v4, :cond_5

    invoke-virtual {v6}, Lvb;->invalidate()V

    invoke-virtual {v6}, Lvb;->requestLayout()V
    ...
    invoke-virtual {v6, v4}, Lvb;->a(I)V
    ...
    iget-object v4, v0, Landroid/support/wearable/view/ActionPage;->b:Lvb;

    invoke-virtual {v2, v3, v5}, Landroid/content/res/TypedArray;->getDimension(IF)F

    move-result v6

    invoke-virtual {v4, v6}, Lvb;->a(F)V
    ...
    iget-object v6, v0, Landroid/support/wearable/view/ActionPage;->a:Luw;
    ...
    iget-object v15, v6, Luw;->c:Ljava/lang/CharSequence;
    ...
    iput-object v8, v6, Luw;->a:Landroid/text/Layout;

    iput-object v4, v6, Luw;->c:Ljava/lang/CharSequence;

    invoke-virtual {v6}, Luw;->requestLayout()V

    invoke-virtual {v6}, Luw;->invalidate()V
    ...
    invoke-virtual {v6}, Luw;->getContext()Landroid/content/Context;
    ...
    iput-object v15, v6, Luw;->b:Landroid/content/res/ColorStateList;

    invoke-virtual {v6}, Luw;->a()V
    ...
    invoke-virtual {v6, v4}, Luw;->a(I)V
    ...
    iget-object v15, v0, Landroid/support/wearable/view/ActionPage;->a:Luw;

    invoke-virtual {v2, v4, v3}, Landroid/content/res/TypedArray;->getInt(II)I

    move-result v4

    invoke-virtual {v15, v4}, Luw;->b(I)V
    ...
    invoke-virtual {v15, v4}, Lvb;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
    ...
    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Luw;
    ...
    iget-object v2, v1, Luw;->a:Landroid/text/Layout;

    if-eqz v2, :cond_1c

    iput-object v8, v1, Luw;->a:Landroid/text/Layout;

    invoke-virtual {v1}, Luw;->requestLayout()V

    invoke-virtual {v1}, Luw;->invalidate()V

    :cond_1c
    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Luw;

    invoke-virtual {v1, v14, v12, v13}, Luw;->a(Ljava/lang/String;II)V

    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->a:Luw;

    invoke-virtual {v0, v1}, Landroid/support/wearable/view/ActionPage;->addView(Landroid/view/View;)V

    iget-object v1, v0, Landroid/support/wearable/view/ActionPage;->b:Lvb;
...
.method protected final onLayout(ZIIII)V
    ...
    iget-object p1, p0, Landroid/support/wearable/view/ActionPage;->b:Lvb;
    ...
    invoke-virtual {p1, p3, p5, v0, v1}, Lvb;->layout(IIII)V
    ...
    iget-object p2, p0, Landroid/support/wearable/view/ActionPage;->a:Luw;

    iget-object p3, p0, Landroid/support/wearable/view/ActionPage;->b:Lvb;

    invoke-virtual {p3}, Lvb;->getBottom()I
    ...
    iget-object p5, p0, Landroid/support/wearable/view/ActionPage;->b:Lvb;

    invoke-virtual {p5}, Lvb;->getBottom()I
    ...
    invoke-virtual {p2, p1, p3, p4, p5}, Luw;->layout(IIII)V
...
.method protected final onMeasure(II)V
    ...
    iget-object v0, p0, Landroid/support/wearable/view/ActionPage;->b:Lvb;
    ...
    iget-object v1, v0, Lvb;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v1, :cond_0

    const/4 v1, 0x0

    invoke-virtual {v0, v1, v1}, Lvb;->measure(II)V

    iget-object v0, p0, Landroid/support/wearable/view/ActionPage;->b:Lvb;

    invoke-virtual {v0}, Lvb;->getMeasuredWidth()I

    move-result v0

    iget-object v1, p0, Landroid/support/wearable/view/ActionPage;->b:Lvb;

    invoke-virtual {v1}, Lvb;->getMeasuredHeight()I
    ...
    invoke-virtual {v1, v0, v2}, Lvb;->measure(II)V
    ...
    iget-object p1, p0, Landroid/support/wearable/view/ActionPage;->a:Luw;
    ...
    invoke-virtual {p1, p2, v0}, Luw;->measure(II)V
...
.method public final setEnabled(Z)V
    ...
    invoke-virtual {v0, p1}, Lvb;->setEnabled(Z)V
...
.method public final setOnClickListener(Landroid/view/View$OnClickListener;)V
    ...
    invoke-virtual {v0, p1}, Lvb;->setOnClickListener(Landroid/view/View$OnClickListener;)V
...
.method public final setStateListAnimator(Landroid/animation/StateListAnimator;)V
    ...
    invoke-virtual {v0, p1}, Lvb;->setStateListAnimator(Landroid/animation/StateListAnimator;)V
