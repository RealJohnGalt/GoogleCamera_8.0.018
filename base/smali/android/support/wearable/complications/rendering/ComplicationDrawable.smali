...
.field private mComplicationRenderer:Luj;
...
.field private final mRendererInvalidateListener:Luh;
...
.method public constructor <init>()V
    ...
    invoke-direct {v0, p0}, Lua;-><init>(Landroid/support/wearable/complications/rendering/ComplicationDrawable;)V
    ...
    invoke-direct {v0, p0}, Lub;-><init>(Landroid/support/wearable/complications/rendering/ComplicationDrawable;)V

    iput-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRendererInvalidateListener:Luh;
...
.method private constructor <init>(Landroid/os/Parcel;)V
    ...
    sget-object v0, Landroid/support/v8/renderscript/Byte2;->YwOxQbwXKdkJ:Ljava/lang/String;
...
.method public synthetic constructor <init>(Landroid/os/Parcel;Ltz;)V
    .locals 0
...
.method private updateStyleIfRequired()V
    ...
    iget-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Luj;
    ...
    invoke-virtual {v1}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lul;
    ...
    invoke-virtual {v2}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lul;

    move-result-object v2

    invoke-virtual {v0, v1, v2}, Luj;->a(Lul;Lul;)V
...
.method public draw(Landroid/graphics/Canvas;)V
    ...
    iget-object v8, v0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Luj;
    ...
    iget-object v6, v8, Luj;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v6, v8, Luj;->c:Landroid/graphics/Rect;
    ...
    iget-object v3, v8, Luj;->w:Lui;

    iget-boolean v6, v3, Lui;->j:Z

    if-ne v6, v4, :cond_1

    iget-boolean v3, v3, Lui;->k:Z
    ...
    iget-object v6, v8, Luj;->z:Lul;

    invoke-direct {v3, v6, v12, v4, v5}, Lui;-><init>(Lul;ZZZ)V

    iput-object v3, v8, Luj;->w:Lui;
    ...
    :cond_3
    iget-object v3, v8, Luj;->v:Lui;

    move-object v10, v3

    :goto_0
    iget-object v3, v8, Luj;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    sget-object v4, Ljld;->VglBM:Ljava/lang/String;

    if-eqz v3, :cond_5

    iget-object v3, v8, Luj;->l:Luo;

    invoke-virtual {v3, v12}, Luo;->b(I)V

    iget-object v3, v8, Luj;->l:Luo;

    iget-object v5, v8, Luj;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v6, v8, Luj;->a:Landroid/content/Context;
    ...
    invoke-virtual {v3, v5}, Luo;->a(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {v3, v4}, Luo;->a(Ljava/lang/CharSequence;)V
    ...
    iget-object v4, v8, Luj;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v5, v8, Luj;->a:Landroid/content/Context;
    ...
    iget-object v1, v8, Luj;->l:Luo;

    invoke-virtual {v1, v12}, Luo;->b(I)V

    goto :goto_2

    :cond_6
    iget-object v1, v8, Luj;->m:Luo;

    invoke-virtual {v1, v4}, Luo;->a(Ljava/lang/CharSequence;)V

    iget-object v1, v8, Luj;->l:Luo;

    invoke-virtual {v1, v11}, Luo;->b(I)V

    :cond_7
    :goto_2
    invoke-virtual/range {p1 .. p1}, Landroid/graphics/Canvas;->save()I

    iget-object v1, v8, Luj;->c:Landroid/graphics/Rect;

    iget v1, v1, Landroid/graphics/Rect;->left:I

    int-to-float v1, v1

    iget-object v2, v8, Luj;->c:Landroid/graphics/Rect;
    ...
    iget-object v1, v10, Lui;->h:Lul;

    invoke-virtual {v8, v1}, Luj;->a(Lul;)I

    move-result v1

    int-to-float v2, v1

    iget-object v3, v8, Luj;->o:Landroid/graphics/RectF;

    iget-object v4, v10, Lui;->f:Landroid/graphics/Paint;

    invoke-virtual {v7, v3, v2, v2, v4}, Landroid/graphics/Canvas;->drawRoundRect(Landroid/graphics/RectF;FFLandroid/graphics/Paint;)V

    iget-object v2, v10, Lui;->h:Lul;

    iget-object v2, v2, Lul;->c:Landroid/graphics/drawable/Drawable;

    if-eqz v2, :cond_8

    invoke-virtual {v10}, Lui;->a()Z

    move-result v2

    if-nez v2, :cond_8

    iget-object v2, v8, Luj;->i:Lun;

    iget-object v3, v10, Lui;->h:Lul;

    iget-object v3, v3, Lul;->c:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v2, v3}, Lun;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v2, v8, Luj;->i:Lun;

    iput v1, v2, Lun;->b:I

    iget-object v1, v8, Luj;->n:Landroid/graphics/Rect;

    invoke-virtual {v2, v1}, Lun;->setBounds(Landroid/graphics/Rect;)V

    iget-object v1, v8, Luj;->i:Lun;

    invoke-virtual {v1, v7}, Lun;->draw(Landroid/graphics/Canvas;)V

    :cond_8
    iget-object v1, v8, Luj;->p:Landroid/graphics/Rect;
    ...
    :cond_9
    iget-object v1, v8, Luj;->d:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v8, Luj;->e:Landroid/graphics/drawable/Drawable;
    ...
    :cond_a
    iget-object v3, v10, Lui;->l:Landroid/graphics/ColorFilter;

    invoke-virtual {v1, v3}, Landroid/graphics/drawable/Drawable;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object v3, v8, Luj;->p:Landroid/graphics/Rect;
    ...
    :cond_b
    :goto_3
    iget-object v1, v8, Luj;->q:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Luj;->k:Lun;

    iget-object v3, v8, Luj;->f:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v3}, Lun;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Luj;->f:Landroid/graphics/drawable/Drawable;
    ...
    iget-object v3, v8, Luj;->g:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v3}, Lun;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Luj;->g:Landroid/graphics/drawable/Drawable;
    ...
    :cond_e
    :goto_4
    iget-object v1, v8, Luj;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    invoke-virtual {v1, v3}, Lun;->setColorFilter(Landroid/graphics/ColorFilter;)V
    ...
    iget-object v2, v2, Lul;->j:Landroid/graphics/ColorFilter;

    invoke-virtual {v1, v2}, Lun;->setColorFilter(Landroid/graphics/ColorFilter;)V

    iget-object v1, v8, Luj;->k:Lun;

    iget-object v2, v10, Lui;->h:Lul;

    iget-object v3, v8, Luj;->q:Landroid/graphics/Rect;

    invoke-virtual {v8, v2, v3}, Luj;->a(Lul;Landroid/graphics/Rect;)I
    ...
    iget-object v2, v8, Luj;->q:Landroid/graphics/Rect;

    invoke-virtual {v1, v2}, Lun;->setBounds(Landroid/graphics/Rect;)V
    ...
    :cond_10
    :goto_6
    iget-object v1, v8, Luj;->r:Landroid/graphics/Rect;
    ...
    iget-object v1, v8, Luj;->j:Lun;

    iget-object v2, v8, Luj;->h:Landroid/graphics/drawable/Drawable;

    invoke-virtual {v1, v2}, Lun;->a(Landroid/graphics/drawable/Drawable;)V

    iget-object v1, v8, Luj;->j:Lun;

    iget-object v2, v10, Lui;->h:Lul;

    iget-object v3, v8, Luj;->r:Landroid/graphics/Rect;
    ...
    iget-object v2, v8, Luj;->r:Landroid/graphics/Rect;
    ...
    :cond_12
    :goto_7
    iget-object v1, v8, Luj;->u:Landroid/graphics/RectF;
    ...
    iget-object v2, v8, Luj;->b:Landroid/support/wearable/complications/ComplicationData;
    ...
    iget-object v1, v10, Lui;->c:Landroid/graphics/Paint;
    ...
    iget-object v2, v8, Luj;->u:Landroid/graphics/RectF;
    ...
    iget-object v6, v10, Lui;->c:Landroid/graphics/Paint;
    ...
    iget-object v6, v10, Lui;->d:Landroid/graphics/Paint;
    ...
    :goto_9
    iget-object v1, v8, Luj;->s:Landroid/graphics/Rect;
    ...
    :cond_15
    iget-object v1, v8, Luj;->x:Landroid/text/TextPaint;

    iget-object v2, v10, Lui;->a:Landroid/text/TextPaint;

    if-eq v1, v2, :cond_16

    iput-object v2, v8, Luj;->x:Landroid/text/TextPaint;

    iget-object v1, v8, Luj;->l:Luo;

    iget-object v2, v8, Luj;->x:Landroid/text/TextPaint;

    invoke-virtual {v1, v2}, Luo;->a(Landroid/text/TextPaint;)V

    iget-object v1, v8, Luj;->l:Luo;

    iget-boolean v2, v10, Lui;->i:Z

    invoke-virtual {v1, v2}, Luo;->a(Z)V

    :cond_16
    iget-object v1, v8, Luj;->l:Luo;

    iget-object v2, v8, Luj;->s:Landroid/graphics/Rect;

    invoke-virtual {v1, v7, v2}, Luo;->a(Landroid/graphics/Canvas;Landroid/graphics/Rect;)V

    :goto_a
    iget-object v1, v8, Luj;->t:Landroid/graphics/Rect;
    ...
    :cond_17
    iget-object v1, v8, Luj;->y:Landroid/text/TextPaint;

    iget-object v2, v10, Lui;->b:Landroid/text/TextPaint;

    if-eq v1, v2, :cond_18

    iput-object v2, v8, Luj;->y:Landroid/text/TextPaint;

    iget-object v1, v8, Luj;->m:Luo;

    iget-object v2, v8, Luj;->y:Landroid/text/TextPaint;
    ...
    iget-object v2, v8, Luj;->t:Landroid/graphics/Rect;
    ...
    iget-object v2, v8, Luj;->o:Landroid/graphics/RectF;

    iget-object v3, v10, Lui;->g:Landroid/graphics/Paint;
    ...
    iget-object v3, v10, Lui;->e:Landroid/graphics/Paint;
...
.method getActiveStyle()Lul;
    ...
    invoke-virtual {v0}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lul;
...
.method getComplicationRenderer()Luj;
    .locals 1
...
.method protected onBoundsChange(Landroid/graphics/Rect;)V
    ...
    invoke-virtual {v0, p1}, Luj;->a(Landroid/graphics/Rect;)V
...
.method public onTap(II)Z
    ...
    :cond_0
    iget-object v0, v0, Luj;->b:Landroid/support/wearable/complications/ComplicationData;
...
.method public setComplicationData(Landroid/support/wearable/complications/ComplicationData;)V
    ...
    invoke-virtual {v0, p1}, Luj;->a(Landroid/support/wearable/complications/ComplicationData;)V
...
.method public setContext(Landroid/content/Context;)V
    ...
    invoke-virtual {v3}, Landroid/support/wearable/complications/rendering/ComplicationStyle$Builder;->a()Lul;

    move-result-object v3

    invoke-direct {v0, v1, v2, v3}, Luj;-><init>(Landroid/content/Context;Lul;Lul;)V

    iput-object v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Luj;

    iget-object v1, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRendererInvalidateListener:Luh;

    iput-object v1, v0, Luj;->A:Luh;
    ...
    :cond_3
    invoke-virtual {v0, v1}, Luj;->a(Ljava/lang/CharSequence;)V

    :goto_0
    iget-object p1, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mComplicationRenderer:Luj;

    iget-boolean v0, p0, Landroid/support/wearable/complications/rendering/ComplicationDrawable;->mRangedValueProgressHidden:Z

    invoke-virtual {p1, v0}, Luj;->a(Z)V
    ...
    invoke-virtual {p1, v0}, Luj;->a(Landroid/graphics/Rect;)V
...
.method public setNoDataText(Ljava/lang/CharSequence;)V
    ...
    invoke-virtual {p1, v0}, Luj;->a(Ljava/lang/CharSequence;)V
...
.method public setRangedValueProgressHidden(Z)V
    ...
    invoke-virtual {v0, p1}, Luj;->a(Z)V
...
.method public writeToParcel(Landroid/os/Parcel;I)V
    ...
    sget-object v2, Lohi;->pQygDGJGzW:Ljava/lang/String;
