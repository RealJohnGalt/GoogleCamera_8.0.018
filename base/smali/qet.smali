...
.method public final entrySet()Ljava/util/Set;
    ...
    iget-object v0, p0, Lqet;->a:Ljava/util/Set;
    ...
    iput-object v0, p0, Lqet;->a:Ljava/util/Set;
...
.method public keySet()Ljava/util/Set;
    ...
    iget-object v0, p0, Lqet;->b:Ljava/util/Set;

    if-nez v0, :cond_0

    new-instance v0, Lqer;

    invoke-direct {v0, p0}, Lqer;-><init>(Ljava/util/Map;)V

    iput-object v0, p0, Lqet;->b:Ljava/util/Set;
...
.method public final values()Ljava/util/Collection;
    ...
    iget-object v0, p0, Lqet;->c:Ljava/util/Collection;

    if-nez v0, :cond_0

    new-instance v0, Lqes;

    invoke-direct {v0, p0}, Lqes;-><init>(Ljava/util/Map;)V

    iput-object v0, p0, Lqet;->c:Ljava/util/Collection;
