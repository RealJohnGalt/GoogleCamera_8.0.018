...
.field public final c:Ldbs;


# direct methods
.method public constructor <init>(Lncq;Ldbs;)V
    .locals 2
    ...
    iput-object p1, p0, Lhhx;->a:Lncr;

    iput-object p2, p0, Lhhx;->c:Ldbs;
...
# virtual methods
.method public final a(Lnxu;DD)V
    .locals 7

    sget-object p4, Landroid/hardware/camera2/CaptureResult;->SENSOR_TIMESTAMP:Landroid/hardware/camera2/CaptureResult$Key;

    invoke-interface {p1, p4}, Lnxu;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p5}, Lnxu;->a(Landroid/hardware/camera2/CaptureResult$Key;)Ljava/lang/Object;
    ...
    invoke-virtual {p5, v0, v1, v2, v3}, Ldbs;->a(JJ)V

    :cond_0
    iget-wide p4, p0, Lhhx;->b:D
    ...
    invoke-interface {p1, p4}, Lncr;->d(Ljava/lang/String;)V
