...
.field public final synthetic e:Lkld;


# direct methods
.method public constructor <init>(Lkld;ZZZZ)V
    .locals 0

    iput-object p1, p0, Lklc;->e:Lkld;

    iput-boolean p2, p0, Lklc;->a:Z

    iput-boolean p3, p0, Lklc;->b:Z

    iput-boolean p4, p0, Lklc;->c:Z

    iput-boolean p5, p0, Lklc;->d:Z
...
.method private final a()V
    ...
    invoke-virtual {v0, v1}, Lkld;->e(Llhg;)V
...
.method private final b()V
    ...
    iget-object v1, v0, Lklc;->e:Lkld;

    sget-object v2, Lkld;->a:Ljava/lang/String;

    invoke-static {v2}, Lkxm;->b(Ljava/lang/String;)V

    iget-object v2, v1, Lkld;->e:Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;
    ...
    iget-object v15, v14, Lkli;->a:Llhg;
    ...
    invoke-static {v4}, Lkml;->d(Landroid/content/Context;)Lpxt;
    ...
    :cond_2
    invoke-static {v15}, Llhd;->a(Llhg;)Llhd;
    ...
    invoke-virtual {v4, v8}, Llhd;->a(Landroid/content/res/Resources;)Landroid/graphics/drawable/Drawable;
    ...
    invoke-static {v0}, Lkml;->c(Landroid/content/Context;)Lpxt;
    ...
    invoke-static {v0}, Lkml;->e(Landroid/content/Context;)Lpxt;
    ...
    invoke-virtual {v0, v3}, Llhd;->b(Landroid/content/res/Resources;)Ljava/lang/String;
    ...
    invoke-direct {v0, v2, v15}, Lklg;-><init>(Lcom/google/android/apps/camera/ui/modeswitcher/MoreModesGrid;Llhg;)V
    ...
    iput-object v7, v14, Lkli;->b:Landroid/view/View;
    ...
    iget-object v2, v1, Lkld;->b:Ljava/util/EnumMap;
    ...
    invoke-virtual {v1, v3}, Lkld;->c(Llhg;)Z

    move-result v4

    if-eqz v4, :cond_b

    sget-object v4, Lkld;->a:Ljava/lang/String;
    ...
    iget-object v4, v1, Lkld;->b:Ljava/util/EnumMap;
    ...
    invoke-static {v0}, Lmwc;->a(Ljava/util/Collection;)Lmvp;
    ...
    invoke-virtual {v1, v0}, Lkld;->h(Llhg;)V

    sget-object v0, Llhg;->p:Llhg;

    invoke-virtual {v1, v0}, Lkld;->g(Llhg;)V

    :cond_d
    const/4 v0, 0x1

    iput-boolean v0, v1, Lkld;->g:Z
...
.method public final bridge synthetic a(Ljava/lang/Object;)V
    ...
    iget-object p1, p0, Lklc;->e:Lkld;

    sget-object v0, Llhg;->k:Llhg;

    invoke-virtual {p1, v0}, Lkld;->e(Llhg;)V

    :cond_0
    invoke-direct {p0}, Lklc;->b()V

    iget-object p1, p0, Lklc;->e:Lkld;

    iget-object p1, p1, Lkld;->h:Lnde;
