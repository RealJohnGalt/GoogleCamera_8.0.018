...
# direct methods
.method public constructor <init>(Lncq;Ljava/lang/Runnable;)V
    .locals 1
    ...
    iput-object v0, p0, Licd;->c:Ljava/util/LinkedList;

    const/4 v0, 0x0

    iput-boolean v0, p0, Licd;->e:Z

    iput-object p2, p0, Licd;->g:Ljava/lang/Runnable;
...
.method public final a(Licf;)V
    ...
    :try_start_0
    iget-object v1, p0, Licd;->c:Ljava/util/LinkedList;
    ...
    iget-object v2, p0, Licd;->c:Ljava/util/LinkedList;
    ...
    iget-boolean p1, p0, Licd;->e:Z

    if-nez p1, :cond_0

    invoke-virtual {p0}, Licd;->a()V
