...
.method public constructor <init>(IIIIIZZZ[Landroid/hardware/camera2/params/MeteringRectangle;[Landroid/hardware/camera2/params/MeteringRectangle;[Landroid/hardware/camera2/params/MeteringRectangle;)V
    ...
    iput-object p1, p0, Lnnt;->a:Ljava/lang/Boolean;

    invoke-static {p7}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object p1

    iput-object p1, p0, Lnnt;->b:Ljava/lang/Boolean;

    invoke-static {p8}, Ljava/lang/Boolean;->valueOf(Z)Ljava/lang/Boolean;

    move-result-object p1

    iput-object p1, p0, Lnnt;->c:Ljava/lang/Boolean;

    iput-object p9, p0, Lnnt;->d:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object p10, p0, Lnnt;->e:[Landroid/hardware/camera2/params/MeteringRectangle;

    iput-object p11, p0, Lnnt;->f:[Landroid/hardware/camera2/params/MeteringRectangle;
...
.method public final equals(Ljava/lang/Object;)Z
    ...
    invoke-virtual {p1}, Lnnt;->a()Ljava/lang/Integer;
    ...
    invoke-virtual {p1}, Lnnt;->b()Ljava/lang/Integer;
    ...
    invoke-virtual {p1}, Lnnt;->c()Ljava/lang/Integer;
    ...
    invoke-virtual {p1}, Lnnt;->d()Ljava/lang/Integer;
    ...
    invoke-virtual {p1}, Lnnt;->e()Ljava/lang/Integer;
    ...
    iget-object v0, p0, Lnnt;->d:[Landroid/hardware/camera2/params/MeteringRectangle;

    iget-object v2, p1, Lnnt;->d:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v0, p0, Lnnt;->e:[Landroid/hardware/camera2/params/MeteringRectangle;

    iget-object v2, p1, Lnnt;->e:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v0, p0, Lnnt;->f:[Landroid/hardware/camera2/params/MeteringRectangle;

    iget-object v2, p1, Lnnt;->f:[Landroid/hardware/camera2/params/MeteringRectangle;
    ...
    iget-object v0, p0, Lnnt;->a:Ljava/lang/Boolean;

    iget-object v2, p1, Lnnt;->a:Ljava/lang/Boolean;
...
.method public final hashCode()I
    ...
    iget-object v1, p0, Lnnt;->f:[Landroid/hardware/camera2/params/MeteringRectangle;
